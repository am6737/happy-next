...
const LegacyAttachmentContentSchema = z.object({
    ...
    image: z.object({ width: z.number(), height: z.number(), thumbhash: z.string().optional() }).optional(),
}).passthrough();
...
export const AttachmentContentSchema = z.discriminatedUnion('v', [LegacyAttachmentContentSchema, EncryptedAttachmentContentSchema]);
