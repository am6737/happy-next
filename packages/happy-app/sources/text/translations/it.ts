...
export const it: TranslationStructure = {
    ...
    settings: {
        ...
        terminal: 'Terminale',
        terminalSubtitle: 'Apri shell sulle tue macchine collegate',
        history: 'History',
    ...
    dootask: {
        ...
        accountLogin: 'Accesso con account',
        qrLogin: 'Accesso con QR',
        switchToAccount: 'Accesso con account',
        switchToQr: 'Accesso con QR',
        qrLoginHint: 'Usa l’app mobile di DooTask per scansionare il codice QR e accedere',
        qrRefresh: 'Tocca il codice QR per aggiornarlo',
    ...
    github: {
        ...
        closed: 'Chiusi',
        merged: 'Uniti',
        searchIssues: 'Cerca segnalazioni...',
        searchPullRequests: 'Cerca pull request...',
        searchRepos: 'Cerca repository...',
        selectRepo: 'Seleziona repository',
        switchRepo: 'Cambia repository',
        findRepo: 'Cerca repository...',
        pinned: 'Fissati',
        allRepos: 'Tutti i repository',
        allReposDescription: 'Segnalazioni e pull request nei tuoi repository',
        assignedToMe: 'Assegnate a me',
        createdByMe: 'Create da me',
        reviewRequested: 'Revisione richiesta',
        noRepos: 'Nessun repository trovato',
        noIssues: 'Nessuna segnalazione trovata',
        noPullRequests: 'Nessuna pull request trovata',
        comments: 'Commenti',
        aiSession: 'Sessione IA',
        connectFirst: 'Collega il tuo account GitHub nelle Impostazioni per iniziare.',
        relatedSessions: 'Sessioni correlate',
    ...
    settingsAppearance: {
        ...
        foldTurnProcess: 'Comprimi i passaggi conclusi',
        foldTurnProcessDescription: 'Un turno concluso mostra le chiamate agli strumenti in una riga, che si apre al tocco',
    ...
    settingsDesktop: {
        title: 'Desktop',
        footer: 'Controlla il comportamento di Happy Next come app desktop.',
        nativeNotificationsTitle: 'Notifiche desktop',
        nativeNotificationsSubtitle: 'Mostra notifiche di sistema per i nuovi messaggi',
        closeToTrayTitle: 'Chiudi nell’area di notifica',
        closeToTraySubtitle: 'Mantieni la connessione quando la finestra è chiusa',
        autostartTitle: 'Avvia all’accesso',
        autostartSubtitle: 'Avvia nascosto nell’area di notifica dopo l’accesso',
        shortcutTitle: 'Scorciatoia globale mostra/nascondi',
        shortcutSubtitle: 'Usa Cmd/Ctrl+Shift+H ovunque',
    ...
    errors: {
        ...
        sessionUnavailable: 'Impossibile inviare: questa sessione non è disponibile. Potrebbe essere stata eliminata o la condivisione revocata.',
    ...
    newSession: {
        ...
        repos: {
            ...
            folderPicker: {
                ...
                inlineConfirmTitle: 'Conferma percorso di clone',
                inlineConfirmDescription: 'Il repository verrà clonato in questo percorso sulla macchina.',
                inlineConfirmPathLabel: 'Percorso completo',
                inlineConfirmBrowse: 'Sfoglia',
                inlineConfirmCancel: 'Annulla',
                inlineConfirmConfirm: 'Conferma',
                toggleHidden: 'Mostra cartelle nascoste',
            },
    ...
    sessionInfo: {
        ...
        markerOrange: 'Indicatore arancione',
        markerYellow: 'Indicatore giallo',
        markerGreen: 'Indicatore verde',
        markerBlue: 'Indicatore blu',
        markerPurple: 'Indicatore viola',
        markerGray: 'Indicatore grigio',
        ...
        newSession: 'Nuova sessione',
        newSessionSubtitle: 'Avvia una nuova sessione usando la macchina e la directory di lavoro correnti',
        openTerminal: 'Terminale',
        openTerminalSubtitle: 'Apri una shell nella directory di lavoro di questa sessione',
        revealInFinder: 'Mostra nel Finder',
        revealInFolder: 'Mostra nella cartella',
        revealInFileManagerFailed: 'Impossibile mostrare questa cartella',
        delegationHistory: 'Cronologia deleghe',
        delegationHistorySubtitle: 'Visualizza le attività delegate avviate da questa conversazione e il relativo stato',
        ...
        updateCliInstructions: 'Esegui happy update',
    ...
    tools: {
        ...
        plan: {
            expand: 'Mostra il piano completo',
    ...
    files: {
        preview: {
            imageNotRegistered: "Questa chiamata non ha un'immagine registrata. Le chiamate precedenti potrebbero non supportare l'anteprima.",
            imageMissing: "L'immagine originale non esiste più.",
            imageChanged: "Il file immagine o il percorso è stato sostituito. Accesso all'anteprima negato.",
            reload: "Ricarica",
            ...
            commit: "Commit",
            deleted: "Deleted: showing previous version",
            diffUnavailable: "Diff unavailable",
            changed: "Binary file changed",
            unavailable: "Preview unavailable. Check the session connection and CLI version, then retry.",
            tooLarge: "File exceeds the preview limit (text: 2 MiB; PDF/images: 20 MiB).",
            renderError: "Unable to render this file",
            ...
            notFound: "No matches",
            loading: "Loading",
            expired: "Preview expired. Reload the file.",
            denied: "This file cannot be accessed for preview.",
            unsupported: "Unsupported or damaged file",
        },
        statusTitle: 'Stato dei file',
        searchChangesPlaceholder: 'Cerca file modificati...',
        noPendingChanges: 'Nessuna modifica da aggiungere allo stage o confermare',
    ...
    repository: {
        ...
        private: 'Privato',
        public: 'Pubblico',
        updatedAgo: ({ time }: { time: string }) => `Aggiornato ${time}`,
        liveSessions: ({ count }: { count: number }) => `${count} attive`,
        commitsCount: ({ count }: { count: number }) => `${count} commit`,
        totalContributorsCount: ({ count }: { count: number }) => `${count} contributor${count !== 1 ? 's' : ''} total`,
        noContributors: 'Ancora nessun collaboratore',
        ...
        emptyIssuesSubtitle: 'Apri un issue per tracciare bug o idee.',
        ...
        selectedCount: ({ count }: { count: number }) => `${count} selezionat${count !== 1 ? 'i' : 'o'}`,
        batchDelete: 'Elimina',
        batchArchive: 'Archivia',
        batchDeleteConfirm: ({ count }: { count: number }) => `Eliminare ${count} session${count !== 1 ? 'i' : 'e'}?`,
        batchDeleteWarning: 'Questa azione non può essere annullata. Tutti i messaggi e i dati associati a queste sessioni verranno eliminati definitivamente.',
        batchArchiveConfirm: ({ count }: { count: number }) => `Archiviare ${count} session${count !== 1 ? 'i' : 'e'}?`,
        batchArchiveWarning: 'Queste sessioni verranno fermate e archiviate.',
        batchDeleteFailed: ({ count }: { count: number }) => `Impossibile eliminare ${count} session${count !== 1 ? 'i' : 'e'}`,
        batchArchiveFailed: ({ count }: { count: number }) => `Impossibile archiviare ${count} session${count !== 1 ? 'i' : 'e'}`,
        readmoreReadme: 'Read full README',
        issueStatus: 'Stato',
        issueAuthor: 'Autore',
        issueLabels: 'Etichette',
        issueCreated: 'Creato',
        issueDescription: 'Descrizione',
        noDescription: 'Nessuna descrizione fornita.',
        copyPrUrl: 'Copia URL PR',
        copyPrNumber: 'Copia numero PR',
        prBranch: 'Ramo',
        prMerged: 'Unito',
        closePr: 'Chiudi Pull Request',
        reopenPr: 'Riapri Pull Request',
        copyIssueUrl: 'Copia URL issue',
        openInGithub: 'Apri in GitHub',
        copyIssueNumber: 'Copia numero issue',
        closeIssue: 'Chiudi issue',
        reopenIssue: 'Riapri issue',
        updateStateFailed: 'Impossibile aggiornare lo stato.',
    },
    ...
    terminalSession: {
        title: 'Terminale',
        openFailed: 'Impossibile aprire un terminale',
        empty: 'Nessun terminale aperto',
        newTerminal: 'Nuovo terminale',
        machineOffline: 'Macchina offline · lo schermo non si aggiorna più',
        duplicateTerminal: 'Duplica terminale',
        closeTerminal: 'Chiudi terminale',
        renameTerminalHint: 'Dai a questo terminale un nome suo. Lascia vuoto per tornare a quello attuale.',
        duplicateFailed: 'Impossibile duplicare il terminale',
        closeTab: ({ label }: { label: string }) => `Chiudi ${label}`,
    },
    ...
    repoSettings: {
        ...
        installGithubAppDesc: 'Necessario per l\'automazione basata su webhook',
        githubAppInstalled: 'GitHub App installata',
        machines: 'Macchine e directory di lavoro',
        machinesFooter: 'Vinci questo repository a una macchina per sessioni e pilota automatico',
        noMachinesRegistered: 'Nessuna macchina registrata',
        noMachinesAvailable: 'Nessuna macchina disponibile. Aggiungi prima una macchina.',
        machineOffline: 'offline',
        machineOnline: 'in linea',
        noMachineAvailable: 'Nessuna macchina disponibile',
        noMachineAvailableNewSession: 'Registra questo repository su una macchina per creare sessioni',
        noMachineAvailableAutoPilot: 'Register this repository on an available machine',
        registerRepoOnMachine: 'Registra su questa macchina',
        repoAlreadyRegistered: 'Questo repository è già registrato su questa macchina',
        machineOfflineCannotRegister: 'La macchina è offline. Connettila per registrare.',
        notBound: 'Non collegato',
        notBoundDesc: 'Questo repository non è registrato su nessuna macchina. Collegalo per abilitare sessioni e pilota automatico.',
        selectMachine: 'Seleziona macchina',
        changeMachine: 'Cambia macchina',
        unbindMachine: 'Scollega',
        unbindAction: 'Scollega',
        unbindConfirmTitle: 'Scollegare la macchina?',
        unbindConfirmMessage: ({ repo }: { repo: string }) => `Scollegare ${repo}? Le sessioni esistenti sulla macchina vengono mantenute; puoi ricollegarla in seguito.`,
        confirmPath: 'Conferma percorso',
        parentPath: 'Percorso padre',
        bindingRepoName: 'Nome repository',
        fullPath: 'Percorso completo',
        fullPathPlaceholder: '/Users/xxx/projects/repo-name',
        pathAlreadyExists: 'Questo percorso esiste già. Scegli un nome o percorso diverso.',
        ...
        selectSchedule: 'Seleziona pianificazione',
        dangerZone: 'Zona di pericolo',
        removeRepo: 'Rimuovi repository',
        removeRepoDesc: 'Rimuovi questo repository da Happy. Questo non eliminerà il repository GitHub.',
        removeRepoTitle: 'Rimuovere repository?',
        removeRepoMessage: ({ repo }: { repo: string }) => `Sei sicuro di voler rimuovere "${repo}" da Happy? Il repository GitHub non verrà eliminato.`,
        clearSessions: 'Cancella sessioni locali',
        clearSessionsDesc: 'Elimina tutti i dati delle sessioni locali per questo repository',
        clearSessionsTitle: 'Cancellare sessioni?',
        clearSessionsMessage: ({ repo }: { repo: string }) => `Sei sicuro di voler cancellare tutte le sessioni locali per "${repo}"? Questa azione non può essere annullata.`,
    },


    repoBinding: {
        cannotProbeTitle: 'Impossibile ispezionare il percorso',
        machineOfflineMessage: 'La macchina di destinazione è offline.',
        bashFailedMessage: ({ detail }: { detail: string }) => `Impossibile ispezionare il percorso sulla macchina: ${detail || 'errore sconosciuto'}`,
        wrongRemoteTitle: 'Repository differente',
        wrongRemoteMessage: ({ found, expected }: { found: string; expected: string }) => `Questa directory è un clone di ${found}, non di ${expected}. Scegli un altro percorso.`,
        dirNotEmptyTitle: 'Directory non vuota',
        dirNotEmptyMessage: ({ path }: { path: string }) => `${path} non è un repository git e contiene file. Scegli una directory vuota o un percorso che ancora non esiste.`,
        cloneConfirmTitle: ({ slug }: { slug: string }) => `Clonare ${slug}?`,
        cloneConfirmMissingMessage: ({ path }: { path: string }) => `${path} non esiste sulla macchina. Clonare il repository qui?`,
        cloneConfirmEmptyMessage: ({ path }: { path: string }) => `${path} è vuota. Clonare il repository in questa directory?`,
        cloneAction: 'Clona',
        cloningTitle: ({ slug }: { slug: string }) => `Clonazione di ${slug}…`,
        cloningElapsed: ({ seconds }: { seconds: string }) => `${seconds} s`,
        cloningWaiting: 'In attesa dell\'output di git…',
        cloningHint: 'La prima clonazione può richiedere un minuto. Mantieni l\'app aperta.',
        cloneSucceededTitle: 'Clonazione riuscita',
        cloneFailedTitle: 'Clonazione fallita',
        cloneNoOutput: '(nessun output)',
        cloneFailedHint: 'Assicurati che la macchina abbia effettuato l\'accesso a GitHub (esegui `gh auth login` sulla macchina) oppure clona manualmente.',
    },

    chatSession: {
        cardTitle: 'Parla di questo issue',
        cardSubtitle: 'Apri una sessione precaricata con il contesto dell\'issue',
        machineUnavailableTitle: 'Macchina non disponibile',
        machineUnavailableMessage: 'Per discutere serve una macchina online vincolata al repository. Apri le impostazioni del repository per sceglierla o cambiarla.',
        openRepoSettings: 'Apri impostazioni repo',
    },
    ...
    issueComments: {
        ...
        submit: 'Commenta',
        errorTitle: 'Errore',
        errorReconnect: 'Riconnetti il tuo account GitHub con permessi aggiornati.',
        errorFallback: 'Invio del commento fallito.',
        takePhoto: 'Scatta foto',
        chooseFromAlbum: 'Scegli dall\'album',
        ...
        edit: 'Modifica',
        delete: 'Elimina',
        editing: 'Modifica commento…',
        deleteConfirmTitle: 'Elimina commento',
        deleteConfirmMessage: 'Sei sicuro di voler eliminare questo commento? Non è possibile annullare.',
        deleteFailed: 'Impossibile eliminare il commento.',
        editFailed: 'Impossibile aggiornare il commento.',
    },

    issueDetail: {
        aiSession: 'Avvia sessione IA',
    },
    ...
    lab: {
        ...
        pullRequestNotFound: 'Pull request non trovata',
        ...
        cloudStop: 'Stop',
        cloudStart: 'Start',
        machinesTab: 'Macchine',
        addMachine: 'Aggiungi macchina',
        machineQrTitle: 'Riga di comando',
        machineQrSubtitle: 'Esegui happy agent --register sulla tua macchina',
        machineQrRunHint: 'Esegui questo comando sulla tua macchina:',
        machineQrWaiting: 'In attesa della connessione dell\'agente…',
        machineQrSimulate: 'Simula connessione',
        machineQrSuccess: 'Agente connesso!',
        machineDockerTitle: 'Docker Run',
        machineDockerSubtitle: 'Esegui Happy Agent in un contenitore',
        machineDockerCommand: 'docker run happy-agent',
        machineDockerGenerating: 'Generazione comando Docker…',
        machineDockerRunHint: 'Copia ed esegui questo comando sul tuo host Docker:',
        machineDockerWaiting: 'In attesa di connessione del contenitore Docker…',
        machineDockerTokenWarning: 'Il comando contiene un token monouso. Salvalo ora — non potrai recuperarlo in seguito.',
        machineDockerSuccess: 'Agente Docker connesso!',
        machineServerTitle: 'Server Cloud',
        machineServerSubtitle: 'Crea una macchina cloud gestita dal server',
        machineServerNamePlaceholder: 'Nome macchina (opzionale)',
        machineServerCreate: 'Crea macchina server',
        machineServerSuccess: 'Macchina cloud creata!',
        machineCopy: 'Copia',
        machineCopied: 'Comando copiato',
        machineViewMachine: 'Visualizza macchina',
        machineRegisterTitle: 'Registra macchina',
        machineRegisterDocker: 'Esegui comando Docker',
        machineSectionRecommended: 'Consigliato',
        machineSectionOther: 'Altri metodi',
        machineDockerRegenerate: 'Rigenera comando',
        machineSuccessTitle: 'Macchina registrata',
        machineSuccessSubtitle: 'Il tuo agent è collegato e pronto all\u2019uso.',
        machineTypeLocal: 'Locale',
        machineTypeCloud: 'Cloud',
        machinesSelect: 'Seleziona',
        machinesDone: 'Fatto',
        machinesDeleteCount: ({ count }: { count: number }) => `Elimina (${count})`,
        machinesDeleteOneTitle: 'Eliminare la macchina?',
        machinesDeleteOneMessage: 'Questa macchina sarà rimossa dal tuo account. Questa azione non può essere annullata.',
        machinesDeleteManyTitle: 'Eliminare le macchine?',
        machinesDeleteManyMessage: ({ count }: { count: number }) => `Rimuovere ${count} macchine dal tuo account? Questa azione non può essere annullata.`,
        machinesDeleteFailed: 'Impossibile eliminare la macchina',
        machineStatusOnline: 'Online',
        machineStatusOffline: 'Offline',
        machineCloudProvisioning: 'Provisioning…',
        machineCloudFailedShort: 'Errore',
        machineCloudFailed: ({ error }: { error: string }) => `Errore di provisioning: ${error}`,
        launchTypeDocker: 'Docker',
        launchTypeCloud: 'Server Cloud',
    },
    ...
    message: {
        ...
        compactSummaryPlaceholder: ({ chars }: { chars: number }) => `Contesto compattato (${chars} caratteri). Tocca per aprire.`,
    ...
    textSelection: {
        ...
        titleOriginalText: 'Vedi testo originale',
