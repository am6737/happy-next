...
export const it: TranslationStructure = {
    ...
    repoSettings: {
        ...
        repoSize: 'Dimensione',
        githubSync: 'Sincronizzazione GitHub',
        ...
        noMachineAvailableAutoPilot: 'Registra questo repository su una macchina disponibile per usare Auto Pilot',
        ...
        automationEnabledDesc: 'Abilita automazione problemi IA',
        autoPilotNewIssues: 'Auto-correggi nuovi problemi',
        autoPilotNewIssuesDesc: 'Avvia automaticamente l\'agente IA alla creazione di nuovi problemi',
        scheduled: 'Auto Pilot Pianificato',
        selectSchedule: 'Seleziona pianificazione',
        custom: 'Personalizzato...',
        customCron: 'Espressione cron personalizzata',
        customCronMessage: 'Inserisci un\'espressione cron (es. 0 * * * * per ogni ora)',
        customCronHelp: 'Formato cron: minuto ora giorno-mese mese giorno-settimana. Esempio: 0 */6 * * * viene eseguito ogni 6 ore.',
        disabled: 'Disabilitato',
        triggerLabels: 'Etichette trigger',
        triggerLabelsFooter: 'L\'IA auto-correggerá solo problemi con queste etichette',
    ...
    lab: {
        ...
        addMachine: 'Aggiungi macchina',
        machineQrTitle: 'Scansiona codice QR',
        ...
        machineManualTitle: 'URL manuale',
        machineManualSubtitle: 'Connetti tramite un endpoint personalizzato',
        machineManualPlaceholder: 'https://your-machine:3000',
        machineManualConnect: 'Connetti',
        machineManualUrlInvalid: 'Formato URL non valido',
        machineCopied: 'Comando copiato',
        machineRegisterTitle: 'Registra macchina',
        machineRegisterQr: 'Scansiona per registrare',
        machineRegisterDocker: 'Esegui comando Docker',
        machineRegisterManual: 'Connessione manuale',
