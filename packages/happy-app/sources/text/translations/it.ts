...
export const it: TranslationStructure = {
    ...
    session: {
        ...
        attachmentDownloadFailed: 'Impossibile scaricare questo allegato',
        fileTooLarge: 'I file devono avere una dimensione massima di 25 MB',
        tooManyAttachments: 'Puoi allegare fino a 10 file',
        attachmentsUnsupported: 'Gli allegati richiedono una CLI aggiornata. Aggiorna o riavvia la CLI e riprova.',
        pasteFromClipboard: 'Incolla dagli appunti',
        dropImagesToAttach: 'Rilascia le immagini per allegarle',
        dropFilesToAttach: 'Rilascia i file per allegarli',
        sharing: {
            title: 'Condivisione',
