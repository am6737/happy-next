...
export const en: TranslationStructure = {
    ...
    session: {
        ...
        attachmentDownloadFailed: 'Unable to download this attachment',
        fileTooLarge: 'Files must be 25 MB or smaller',
        tooManyAttachments: 'You can attach up to 10 files',
        attachmentsUnsupported: 'File attachments require an updated CLI. Update or restart the CLI and try again.',
