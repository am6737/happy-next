...
export const en: TranslationStructure = {
    ...
    repository: {
        ...
        batchDeleteConfirm: ({ count }: { count: number }) => `Delete ${count} session${count !== 1 ? 's' : ''}?`,
        batchDeleteWarning: 'This action cannot be undone. All messages and data associated with these sessions will be permanently deleted.',
        batchArchiveConfirm: ({ count }: { count: number }) => `Archive ${count} session${count !== 1 ? 's' : ''}?`,
        batchArchiveWarning: 'These sessions will be stopped and archived.',
        batchDeleteFailed: ({ count }: { count: number }) => `Failed to delete ${count} session${count !== 1 ? 's' : ''}`,
        batchArchiveFailed: ({ count }: { count: number }) => `Failed to archive ${count} session${count !== 1 ? 's' : ''}`,
