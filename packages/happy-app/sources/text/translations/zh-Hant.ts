...
export const zhHant: TranslationStructure = {
    ...
    repoSettings: {
        ...
        noMachineAvailableAutoPilot: '請先在可用機器上註冊此倉庫以使用 Auto Pilot',
        ...
        automationEnabled: '自動化已啟用',
        automationEnabledDesc: '啟用AI問題自動化',
        autoPilotNewIssues: '自動修復新問題',
        autoPilotNewIssuesDesc: '創建新問題時自動啟動AI代理',
        scheduled: '計劃自動修復',
        selectSchedule: '選擇定時計劃',
        custom: '自訂...',
        customCron: '自訂Cron表達式',
        customCronMessage: '輸入Cron表達式（例如：0 * * * * 表示每小時）',
        customCronHelp: 'Cron格式：分 時 日 月 星期。例如：0 */6 * * * 表示每6小時執行一次。',
        disabled: '已停用',
        triggerLabels: '觸發標籤',
        triggerLabelsFooter: 'AI只會自動修復帶有這些標籤的問題',
        dangerZone: '危險區域',
        removeRepo: '移除倉庫',
    ...
    lab: {
        sectionTitle: '實驗室',
        entryTitle: '儲存庫',
        entrySubtitle: '雲端儲存庫、Issue 與自動化',
        screenTitle: '儲存庫',
        ...
        machineManualTitle: '手動 URL',
        machineManualSubtitle: '透過自訂端點連線',
        machineManualPlaceholder: 'https://your-machine:3000',
        machineManualConnect: '連線',
        machineManualUrlInvalid: '無效的 URL 格式',
        machineCopied: '命令已複製',
        machineRegisterTitle: '註冊機器',
        machineRegisterQr: '掃描以註冊',
        machineRegisterDocker: '執行 Docker 命令',
        machineRegisterManual: '手動連線',
        machineTypeLocal: '本地',
        machineTypeCloud: '雲端',
    },
