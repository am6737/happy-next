...
export const zhHant: TranslationStructure = {
    ...
    dootask: {
        ...
        accountLogin: '帳號登入',
        qrLogin: '掃碼登入',
        switchToAccount: '帳號登入',
        switchToQr: '掃碼登入',
        qrLoginHint: '使用 DooTask 行動版掃描 QR Code 登入',
        qrRefresh: '點擊 QR Code 重新整理',
    ...
    github: {
        ...
        pinned: '已置頂',
        allRepos: '全部倉庫',
        allReposDescription: '跨倉庫查看議題和拉取請求',
        assignedToMe: '分配給我',
        createdByMe: '由我建立',
        reviewRequested: '待我審查',
        noRepos: '未找到儲存庫',
        noIssues: '未找到議題',
    ...
    settingsAppearance: {
        ...
        foldTurnProcess: '折疊已結束的過程',
        foldTurnProcessDescription: '已結束的回合把工具呼叫收成一行，點一下展開',
    ...
    message: {
        ...
        compactSummaryPlaceholder: ({ chars }: { chars: number }) => `上下文已壓縮（${chars} 字元），點擊查看`,
