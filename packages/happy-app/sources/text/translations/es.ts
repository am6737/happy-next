...
export const es: TranslationStructure = {
    ...
    session: {
        ...
        attachmentDownloadFailed: 'No se pudo descargar este archivo adjunto',
        fileTooLarge: 'Los archivos deben tener 25 MB o menos',
        tooManyAttachments: 'Puedes adjuntar hasta 10 archivos',
        attachmentsUnsupported: 'Los archivos adjuntos requieren una CLI actualizada. Actualiza o reinicia la CLI e inténtalo de nuevo.',
        pasteFromClipboard: 'Pegar desde el portapapeles',
        dropImagesToAttach: 'Suelta las imágenes para adjuntarlas',
        dropFilesToAttach: 'Suelta los archivos para adjuntarlos',
        sharing: {
            title: 'Compartir',
