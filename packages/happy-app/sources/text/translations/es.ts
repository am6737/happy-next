...
export const es: TranslationStructure = {
    ...
    repoSettings: {
        ...
        noMachineAvailableAutoPilot: 'Registra este repositorio en una máquina disponible para usar Auto Pilot',
        ...
        automationEnabledDesc: 'Activar automatización de incidencias con IA',
        autoPilotNewIssues: 'Auto-reparar nuevas incidencias',
        autoPilotNewIssuesDesc: 'Iniciar automáticamente el agente IA al crear nuevas incidencias',
        scheduled: 'Auto Pilot Programado',
        selectSchedule: 'Seleccionar programación',
        custom: 'Personalizado...',
        customCron: 'Expresión cron personalizada',
        customCronMessage: 'Introduce una expresión cron (p. ej. 0 * * * * para cada hora)',
        customCronHelp: 'Formato cron: minuto hora día-mes mes día-semana. Ejemplo: 0 */6 * * * se ejecuta cada 6 horas.',
        disabled: 'Desactivado',
        triggerLabels: 'Etiquetas de activación',
        triggerLabelsFooter: 'La IA solo auto-reparará incidencias con estas etiquetas',
    ...
    lab: {
        ...
        machineManualSubtitle: 'Conectar vía un endpoint personalizado',
        ...
        machineRegisterManual: 'Conexión manual',
