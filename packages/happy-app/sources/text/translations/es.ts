...
export const es: TranslationStructure = {
    ...
    dootask: {
        ...
        accountLogin: 'Acceso con cuenta',
        qrLogin: 'Acceso con QR',
        switchToAccount: 'Acceso con cuenta',
        switchToQr: 'Acceso con QR',
        qrLoginHint: 'Usa la aplicación móvil de DooTask para escanear el código QR e iniciar sesión',
        qrRefresh: 'Toca el código QR para actualizarlo',
    ...
    github: {
        ...
        searchPullRequests: 'Buscar pull requests...',
        searchRepos: 'Buscar repositorios...',
        selectRepo: 'Seleccionar repositorio',
        switchRepo: 'Cambiar repositorio',
        findRepo: 'Buscar repositorio...',
        pinned: 'Fijados',
        allRepos: 'Todos los repositorios',
        allReposDescription: 'Incidencias y pull requests de tus repositorios',
        ...
        noIssues: 'No se encontraron incidencias',
        noPullRequests: 'No se encontraron pull requests',
        comments: 'Comentarios',
        aiSession: 'Sesión IA',
        connectFirst: 'Conecta tu cuenta de GitHub en Ajustes para comenzar.',
        relatedSessions: 'Sesiones relacionadas',
    ...
    settingsAppearance: {
        ...
        foldTurnProcess: 'Contraer los pasos terminados',
        foldTurnProcessDescription: 'Un turno terminado muestra sus llamadas a herramientas en una línea, que se abre al tocar',
    ...
    settingsDesktop: {
        title: 'Escritorio',
        footer: 'Controla el comportamiento de Happy Next como aplicación de escritorio.',
        nativeNotificationsTitle: 'Notificaciones de escritorio',
        nativeNotificationsSubtitle: 'Mostrar notificaciones del sistema para mensajes nuevos',
        closeToTrayTitle: 'Cerrar a la bandeja',
        closeToTraySubtitle: 'Mantener la conexión al cerrar la ventana',
        autostartTitle: 'Iniciar al abrir sesión',
        autostartSubtitle: 'Iniciar oculto en la bandeja al abrir sesión',
        shortcutTitle: 'Atajo global para mostrar u ocultar',
        shortcutSubtitle: 'Usar Cmd/Ctrl+Shift+H desde cualquier lugar',
    ...
    errors: {
        ...
        sessionUnavailable: 'No se puede enviar: esta sesión no está disponible. Puede que se haya eliminado o que se haya dejado de compartir.',
    ...
    newSession: {
        ...
        repos: {
            ...
            folderPicker: {
                ...
                inlineConfirmTitle: 'Confirmar ruta de clonación',
                inlineConfirmDescription: 'El repositorio se clonará en esta ruta de la máquina.',
                inlineConfirmPathLabel: 'Ruta completa',
                inlineConfirmBrowse: 'Explorar',
                inlineConfirmCancel: 'Cancelar',
                inlineConfirmConfirm: 'Confirmar',
                toggleHidden: 'Mostrar carpetas ocultas',
            },
    ...
    sessionInfo: {
        ...
        markerOrange: 'Marcador naranja',
        markerYellow: 'Marcador amarillo',
        markerGreen: 'Marcador verde',
        markerBlue: 'Marcador azul',
        markerPurple: 'Marcador morado',
        markerGray: 'Marcador gris',
        ...
        newSession: 'Nueva sesión',
        newSessionSubtitle: 'Inicia una nueva sesión usando la máquina y el directorio de trabajo actuales',
        openTerminal: 'Terminal',
        openTerminalSubtitle: 'Abrir un shell en el directorio de trabajo de esta sesión',
        revealInFinder: 'Mostrar en Finder',
        revealInFolder: 'Mostrar en la carpeta',
        revealInFileManagerFailed: 'No se pudo mostrar esta carpeta',
        delegationHistory: 'Historial de delegaciones',
        ...
        updateCliInstructions: 'Por favor ejecute happy update',
    ...
    agentInput: {
        ...
        context: {
            ...
            details: ({ usedPercent, remainingPercent, usedTokens, totalTokens }: { usedPercent: number; remainingPercent: number; usedTokens: string; totalTokens: string }) => `Ventana de contexto:\n${usedPercent}% usado (${remainingPercent}% restante)\n${usedTokens} tokens usados, ${totalTokens} en total`,
        },
        suggestion: {
            fileLabel: 'ARCHIVO',
            folderLabel: 'CARPETA',
    ...
    repository: {
        ...
        private: 'Privado',
        public: 'Público',
        updatedAgo: ({ time }: { time: string }) => `Actualizado ${time}`,
        liveSessions: ({ count }: { count: number }) => `${count} activas`,
        commitsCount: ({ count }: { count: number }) => `${count} commit${count !== 1 ? 's' : ''}`,
        ...
        emptyIssuesSubtitle: 'Abre un issue para rastrear errores o ideas.',
        ...
        selectedCount: ({ count }: { count: number }) => `${count} seleccionado${count !== 1 ? 's' : ''}`,
        batchDelete: 'Eliminar',
        batchArchive: 'Archivar',
        batchDeleteConfirm: ({ count }: { count: number }) => `¿Eliminar ${count} sesión${count !== 1 ? 'es' : ''}?`,
        batchDeleteWarning: 'Esta acción no se puede deshacer. Todos los mensajes y datos asociados a estas sesiones se eliminarán permanentemente.',
        batchArchiveConfirm: ({ count }: { count: number }) => `¿Archivar ${count} sesión${count !== 1 ? 'es' : ''}?`,
        batchArchiveWarning: 'Estas sesiones se detendrán y archivarán.',
        batchDeleteFailed: ({ count }: { count: number }) => `Error al eliminar ${count} sesión${count !== 1 ? 'es' : ''}`,
        batchArchiveFailed: ({ count }: { count: number }) => `Error al archivar ${count} sesión${count !== 1 ? 'es' : ''}`,
        readmoreReadme: 'Read full README',
        issueStatus: 'Estado',
        issueAuthor: 'Autor',
        issueLabels: 'Etiquetas',
        issueCreated: 'Creado',
        issueDescription: 'Descripción',
        noDescription: 'Sin descripción proporcionada.',
        copyPrUrl: 'Copiar URL del PR',
        copyPrNumber: 'Copiar número de PR',
        prBranch: 'Rama',
        prMerged: 'Fusionado',
        closePr: 'Cerrar Pull Request',
        reopenPr: 'Reabrir Pull Request',
        copyIssueUrl: 'Copiar URL del issue',
        openInGithub: 'Abrir en GitHub',
        copyIssueNumber: 'Copiar número de issue',
        closeIssue: 'Cerrar issue',
        reopenIssue: 'Reabrir issue',
        updateStateFailed: 'No se pudo actualizar el estado.',
    },
    ...
    terminalSession: {
        title: 'Terminal',
        openFailed: 'No se pudo abrir un terminal',
        empty: 'No hay terminales abiertos',
        newTerminal: 'Nuevo terminal',
        machineOffline: 'Máquina desconectada · la pantalla ha dejado de actualizarse',
        duplicateTerminal: 'Duplicar terminal',
        closeTerminal: 'Cerrar terminal',
        renameTerminalHint: 'Dale a este terminal un nombre propio. Déjalo vacío para volver al que tiene.',
        duplicateFailed: 'No se pudo duplicar el terminal',
        closeTab: ({ label }: { label: string }) => `Cerrar ${label}`,
    },
    ...
    modals: {
        ...
        reviewDemoQrScannedSuccessfully: 'El código QR de demostración para revisión se escaneó correctamente. El escáner QR funciona correctamente.'
    },
    ...
    repoSettings: {
        ...
        installGithubAppDesc: 'Necesario para la automatización basada en webhooks',
        githubAppInstalled: 'GitHub App instalada',
        machines: 'Máquinas y directorios de trabajo',
        machinesFooter: 'Vincula este repositorio a una máquina para sesiones y piloto automático',
        noMachinesRegistered: 'No hay máquinas registradas',
        noMachinesAvailable: 'No hay máquinas disponibles. Añade una máquina primero.',
        machineOffline: 'sin conexión',
        machineOnline: 'en línea',
        noMachineAvailable: 'No hay máquinas disponibles',
        noMachineAvailableNewSession: 'Registra este repositorio en una máquina para crear sesiones',
        noMachineAvailableAutoPilot: 'Register this repository on an available machine',
        registerRepoOnMachine: 'Registrar en esta máquina',
        repoAlreadyRegistered: 'Este repositorio ya está registrado en esta máquina',
        machineOfflineCannotRegister: 'La máquina está sin conexión. Conéctala para registrar.',
        notBound: 'Sin vincular',
        notBoundDesc: 'Este repositorio no está registrado en ninguna máquina. Vinúlalo para habilitar sesiones y piloto automático.',
        selectMachine: 'Seleccionar máquina',
        changeMachine: 'Cambiar máquina',
        unbindMachine: 'Desvincular',
        unbindAction: 'Desvincular',
        unbindConfirmTitle: '¿Desvincular máquina?',
        unbindConfirmMessage: ({ repo }: { repo: string }) => `¿Desvincular ${repo}? Las sesiones existentes en la máquina se conservan; puedes volver a vincular más tarde.`,
        confirmPath: 'Confirmar ruta',
        parentPath: 'Ruta padre',
        bindingRepoName: 'Nombre del repositorio',
        fullPath: 'Ruta completa',
        fullPathPlaceholder: '/Users/xxx/projects/repo-name',
        pathAlreadyExists: 'Esta ruta ya existe. Elija un nombre o ruta diferente.',
        ...
        removeRepoDesc: 'Eliminar este repositorio de Happy. No eliminará el repositorio GitHub.',
        removeRepoTitle: '¿Eliminar repositorio?',
        removeRepoMessage: ({ repo }: { repo: string }) => `¿Estás seguro de que quieres eliminar "${repo}" de Happy? No eliminará el repositorio GitHub.`,
        clearSessions: 'Borrar sesiones locales',
        clearSessionsDesc: 'Eliminar todos los datos de sesiones locales para este repositorio',
        clearSessionsTitle: '¿Borrar sesiones?',
        clearSessionsMessage: ({ repo }: { repo: string }) => `¿Estás seguro de que quieres borrar todas las sesiones locales para "${repo}"? Esta acción no se puede deshacer.`,
    },


    repoBinding: {
        cannotProbeTitle: 'No se puede inspeccionar la ruta',
        machineOfflineMessage: 'La máquina de destino está desconectada.',
        bashFailedMessage: ({ detail }: { detail: string }) => `No se pudo inspeccionar la ruta en la máquina: ${detail || 'error desconocido'}`,
        wrongRemoteTitle: 'Repositorio diferente',
        wrongRemoteMessage: ({ found, expected }: { found: string; expected: string }) => `Este directorio es un clon de ${found}, no de ${expected}. Elige otra ruta.`,
        dirNotEmptyTitle: 'Directorio no vacío',
        dirNotEmptyMessage: ({ path }: { path: string }) => `${path} no es un repositorio git y contiene archivos. Elige un directorio vacío o una ruta que aún no exista.`,
        cloneConfirmTitle: ({ slug }: { slug: string }) => `¿Clonar ${slug}?`,
        cloneConfirmMissingMessage: ({ path }: { path: string }) => `${path} no existe en la máquina. ¿Clonar el repositorio aquí?`,
        cloneConfirmEmptyMessage: ({ path }: { path: string }) => `${path} está vacío. ¿Clonar el repositorio en este directorio?`,
        cloneAction: 'Clonar',
        cloningTitle: ({ slug }: { slug: string }) => `Clonando ${slug}…`,
        cloningElapsed: ({ seconds }: { seconds: string }) => `${seconds} s`,
        cloningWaiting: 'Esperando salida de git…',
        cloningHint: 'La primera clonación puede tardar un minuto. Mantén la aplicación abierta.',
        cloneSucceededTitle: 'Clonación correcta',
        cloneFailedTitle: 'Error al clonar',
        cloneNoOutput: '(sin salida)',
        cloneFailedHint: 'Asegúrate de que la máquina tenga sesión iniciada en GitHub (ejecuta `gh auth login` en la máquina) o clona manualmente.',
    },

    chatSession: {
        cardTitle: 'Chatear sobre este issue',
        cardSubtitle: 'Abre una sesión precargada con el contexto del issue',
        machineUnavailableTitle: 'Máquina no disponible',
        machineUnavailableMessage: 'Para discutir este issue se necesita una máquina en línea vinculada al repositorio. Abre la configuración del repositorio para seleccionar o cambiarla.',
        openRepoSettings: 'Abrir ajustes del repo',
    },
    ...
    issueComments: {
        ...
        submit: 'Comentar',
        errorTitle: 'Error',
        errorReconnect: 'Por favor, vuelve a conectar tu cuenta de GitHub con permisos actualizados.',
        ...
        edit: 'Editar',
        delete: 'Eliminar',
        editing: 'Editando comentario…',
        deleteConfirmTitle: 'Eliminar comentario',
        deleteConfirmMessage: '¿Seguro que quieres eliminar este comentario? No se puede deshacer.',
        deleteFailed: 'Error al eliminar el comentario.',
        editFailed: 'Error al actualizar el comentario.',
    },

    issueDetail: {
        aiSession: 'Iniciar sesión IA',
    },
    ...
    lab: {
        ...
        pullRequestNotFound: 'Pull request no encontrada',
        ...
        cloudStop: 'Stop',
        cloudStart: 'Start',
        machinesTab: 'Máquinas',
        addMachine: 'Añadir máquina',
        machineQrTitle: 'Línea de comandos',
        machineQrSubtitle: 'Ejecuta happy agent --register en tu máquina',
        machineQrRunHint: 'Ejecuta este comando en tu máquina:',
        machineQrWaiting: 'Esperando a que el agente se conecte…',
        machineQrSimulate: 'Simular conexión',
        machineQrSuccess: '¡Agente conectado!',
        machineDockerTitle: 'Docker Run',
        machineDockerSubtitle: 'Ejecuta Happy Agent en un contenedor',
        machineDockerCommand: 'docker run happy-agent',
        machineDockerGenerating: 'Generando comando Docker…',
        machineDockerRunHint: 'Copia y ejecuta este comando en tu host Docker:',
        machineDockerWaiting: 'Esperando a que el contenedor Docker se conecte…',
        machineDockerTokenWarning: 'El comando contiene un token de un solo uso. Guárdalo ahora — no podrás recuperarlo después.',
        machineDockerSuccess: '¡Agente Docker conectado!',
        machineServerTitle: 'Server Cloud',
        machineServerSubtitle: 'Crea una máquina en la nube gestionada por el servidor',
        machineServerNamePlaceholder: 'Nombre de la máquina (opcional)',
        machineServerCreate: 'Crear máquina de servidor',
        machineServerSuccess: '¡Máquina en la nube creada!',
        machineCopy: 'Copiar',
        machineCopied: 'Comando copiado',
        machineViewMachine: 'Ver máquina',
        machineRegisterTitle: 'Registrar máquina',
        machineRegisterDocker: 'Ejecutar comando Docker',
        machineSectionRecommended: 'Recomendado',
        machineSectionOther: 'Otros métodos',
        machineDockerRegenerate: 'Regenerar comando',
        machineSuccessTitle: 'Máquina registrada',
        machineSuccessSubtitle: 'Tu agente está conectado y listo para usarse.',
        machineTypeLocal: 'Local',
        machineTypeCloud: 'Nube',
        machinesSelect: 'Seleccionar',
        machinesDone: 'Listo',
        machinesDeleteCount: ({ count }: { count: number }) => `Eliminar (${count})`,
        machinesDeleteOneTitle: '¿Eliminar máquina?',
        machinesDeleteOneMessage: 'Se eliminará esta máquina de tu cuenta. Esta acción no se puede deshacer.',
        machinesDeleteManyTitle: '¿Eliminar máquinas?',
        machinesDeleteManyMessage: ({ count }: { count: number }) => `¿Eliminar ${count} máquinas de tu cuenta? Esta acción no se puede deshacer.`,
        machinesDeleteFailed: 'No se pudo eliminar la máquina',
        machineStatusOnline: 'En línea',
        machineStatusOffline: 'Desconectada',
        machineCloudProvisioning: 'Aprovisionando…',
        machineCloudFailedShort: 'Error',
        machineCloudFailed: ({ error }: { error: string }) => `Error al aprovisionar: ${error}`,
    ...
    tts: {
        queueTitle: 'Cola de lectura',
        stopCurrent: 'Detener este mensaje',
        removeFromQueue: 'Quitar de la cola',
        showQueue: 'Mostrar cola de lectura',
    },
