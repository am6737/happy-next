...
export const ru: TranslationStructure = {
    ...
    session: {
        ...
        tooManyAttachments: 'Можно прикрепить не более 10 файлов',
        attachmentsUnsupported: 'Для вложений требуется обновлённая версия CLI. Обновите или перезапустите CLI и повторите попытку.',
        pasteFromClipboard: 'Вставить из буфера обмена',
        dropImagesToAttach: 'Отпустите изображения, чтобы прикрепить их',
        dropFilesToAttach: 'Отпустите файлы, чтобы прикрепить их',
        sharing: {
            title: 'Общий доступ',
