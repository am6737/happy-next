...
export const ru: TranslationStructure = {
    ...
    dootask: {
        ...
        switchToAccount: 'Вход в аккаунт',
        switchToQr: 'Вход по QR-коду',
        qrLoginHint: 'Отсканируйте QR-код в мобильном приложении DooTask, чтобы войти',
        qrRefresh: 'Нажмите на QR-код, чтобы обновить его',
    ...
    github: {
        ...
        allReposDescription: 'Задачи и пул-реквесты во всех репозиториях',
        assignedToMe: 'Назначенные мне',
        createdByMe: 'Созданные мной',
        reviewRequested: 'Ожидают моей проверки',
    ...
    settingsAppearance: {
        ...
        foldTurnProcess: 'Сворачивать завершённые шаги',
        foldTurnProcessDescription: 'Завершённый ход показывает вызовы инструментов одной строкой, которая раскрывается по нажатию',
