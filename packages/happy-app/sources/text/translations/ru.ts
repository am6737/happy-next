...
export const ru: TranslationStructure = {
    ...
    repoSettings: {
        ...
        machinesFooter: 'Привяжите репозиторий к машине для сессий и автопилота',
        ...
        noMachineAvailableAutoPilot: 'Зарегистрируйте этот репозиторий на доступной машине для использования Auto Pilot',
        ...
        notBoundDesc: 'Репозиторий не зарегистрирован ни на одной машине. Привяжите его, чтобы включить сессии и автопилот.',
        ...
        automationEnabledDesc: 'Включить AI-автоматизацию задач',
        autoPilotNewIssues: 'Автоисправление новых задач',
        autoPilotNewIssuesDesc: 'Автоматически запускать AI агент при создании новых задач',
        scheduled: 'Запланированный Auto Pilot',
        selectSchedule: 'Выберите расписание',
        custom: 'Своё...',
        customCron: 'Свое выражение cron',
        customCronMessage: 'Введите cron выражение (напр. 0 * * * * для ежечасно)',
        customCronHelp: 'Формат cron: минута час день-месяц месяц день-недели. Пример: 0 */6 * * * запускается каждые 6 часов.',
        disabled: 'Отключено',
        triggerLabels: 'Метки триггеров',
        triggerLabelsFooter: 'AI будет автоматически исправлять только задачи с этими метками',
        dangerZone: 'Опасная зона',
    ...
    lab: {
        ...
        machinesTab: 'Машины',
        addMachine: 'Добавить машину',
        machineQrTitle: 'Сканировать QR-код',
        ...
        machineManualTitle: 'Ручной URL',
        machineManualSubtitle: 'Подключиться через пользовательский endpoint',
        machineManualPlaceholder: 'https://your-machine:3000',
        machineManualConnect: 'Подключить',
        machineManualUrlInvalid: 'Неверный формат URL',
        machineCopied: 'Команда скопирована',
        machineRegisterTitle: 'Зарегистрировать машину',
        machineRegisterQr: 'Сканировать для регистрации',
        machineRegisterDocker: 'Выполнить команду Docker',
        machineRegisterManual: 'Ручное подключение',
