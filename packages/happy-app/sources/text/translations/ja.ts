...
export const ja: TranslationStructure = {
    ...
    dootask: {
        ...
        qrLogin: 'QRコードでログイン',
        switchToAccount: 'アカウントでログイン',
        switchToQr: 'QRコードでログイン',
        qrLoginHint: 'DooTaskのモバイルアプリでQRコードをスキャンしてログインしてください',
        qrRefresh: 'QRコードをタップして更新',
    ...
    settingsAppearance: {
        ...
        foldTurnProcess: '完了した手順を折りたたむ',
        foldTurnProcessDescription: '終わったターンはツール呼び出しを1行にまとめ、タップで展開します',
    ...
    newSession: {
        ...
        repos: {
            ...
            folderPicker: {
                ...
                gitRepo: 'Git リポジトリ',
                selectFile: 'ファイルを選択',
                inlineConfirmTitle: 'クローン先のパスを確認',
                inlineConfirmDescription: 'リポジトリはマシン上のこのパスにクローンされます。',
                inlineConfirmPathLabel: 'フルパス',
                inlineConfirmBrowse: '参照',
                inlineConfirmCancel: 'キャンセル',
                inlineConfirmConfirm: '確認',
                toggleHidden: '隠しフォルダを表示',
            },
    ...
    sessionInfo: {
        ...
        markerRed: '赤のマーカー',
        markerOrange: 'オレンジのマーカー',
        markerYellow: '黄色のマーカー',
        markerGreen: '緑のマーカー',
        markerBlue: '青のマーカー',
        markerPurple: '紫のマーカー',
        markerGray: 'グレーのマーカー',
        ...
        updateCliInstructions: 'happy update を実行してください',
    ...
    repository: {
        ...
        private: 'プライベート',
        public: 'パブリック',
        updatedAgo: ({ time }: { time: string }) => `${time}に更新`,
        liveSessions: ({ count }: { count: number }) => `${count} 件進行中`,
        commitsCount: ({ count }: { count: number }) => `${count} コミット`,
        totalContributorsCount: ({ count }: { count: number }) => `${count} contributor${count !== 1 ? 's' : ''} total`,
        noContributors: 'コントリビューターはまだいません',
        ...
        emptyIssuesSubtitle: 'バグやアイデアを追跡するために Issue を作成してください。',
        ...
        batchDelete: '削除',
        batchArchive: 'アーカイブ',
        batchDeleteConfirm: ({ count }: { count: number }) => `${count}件のセッションを削除しますか？`,
        batchDeleteWarning: 'この操作は元に戻せません。これらのセッションに関連するすべてのメッセージとデータが完全に削除されます。',
        batchArchiveConfirm: ({ count }: { count: number }) => `${count}件のセッションをアーカイブしますか？`,
        batchArchiveWarning: 'これらのセッションは停止してアーカイブされます。',
        batchDeleteFailed: ({ count }: { count: number }) => `${count}件のセッションの削除に失敗しました`,
        batchArchiveFailed: ({ count }: { count: number }) => `${count}件のセッションのアーカイブに失敗しました`,
        ...
        copyPrUrl: 'PR URLをコピー',
        copyPrNumber: 'PR番号をコピー',
        prBranch: 'ブランチ',
        prMerged: 'マージ済み',
        closePr: 'プルリクエストを閉じる',
        reopenPr: 'プルリクエストを再開する',
        copyIssueUrl: 'Issue URLをコピー',
        openInGithub: 'GitHubで開く',
        copyIssueNumber: 'Issue番号をコピー',
        closeIssue: 'Issueを閉じる',
        reopenIssue: 'Issueを再開する',
        updateStateFailed: 'ステータスの更新に失敗しました。',
    },
    ...
    repoSettings: {
        ...
        installGithubApp: 'GitHub App をインストール',
        installGithubAppDesc: 'Webhook ベースの自動化に必要です',
        githubAppInstalled: 'GitHub App インストール済み',
        machines: 'マシンと作業ディレクトリ',
        machinesFooter: 'Bind this repo to a machine for sessions',
        noMachinesRegistered: '登録されているマシンはありません',
        noMachinesAvailable: '利用可能なマシンがありません。まずマシンを追加してください。',
        machineOffline: 'オフライン',
        machineOnline: 'オンライン',
        noMachineAvailable: '利用可能なマシンがない',
        noMachineAvailableNewSession: 'セッションを作成するには、まずマシンでリポジトリを登録してください',
        noMachineAvailableAutoPilot: 'Register this repository on an available machine',
        registerRepoOnMachine: 'このマシンに登録',
        repoAlreadyRegistered: 'このリポジトリは既にこのマシンに登録されています',
        machineOfflineCannotRegister: 'マシンはオフラインです。登録するには接続してください。',
        notBound: '未バインド',
        notBoundDesc: 'This repository is not registered on any machine. Bind it to enable sessions.',
        selectMachine: 'マシンを選択',
        changeMachine: 'マシンを変更',
        unbindMachine: 'バインド解除',
        unbindAction: 'バインド解除',
        unbindConfirmTitle: 'マシンのバインドを解除しますか？',
        unbindConfirmMessage: ({ repo }: { repo: string }) => `${repo} のバインドを解除しますか？マシン上の既存セッションは保持され、後で再バインドできます。`,
        confirmPath: 'パスを確認',
        parentPath: '親パス',
        bindingRepoName: 'リポジトリ名',
        fullPath: 'フルパス',
        fullPathPlaceholder: '/Users/xxx/projects/repo-name',
        pathAlreadyExists: 'このパスは既に存在します。別の名前またはパスを選択してください。',
        workingDir: '作業ディレクトリ',
        targetBranch: 'ターゲットブランチ',
        disabled: 'Disabled',
        custom: 'Custom...',
        ...
        dangerZone: '危険ゾーン',
        removeRepo: 'リポジトリを削除',
        removeRepoDesc: 'このリポジトリをHappyから削除します。GitHubリポジトリは削除されません。',
        removeRepoTitle: 'リポジトリを削除しますか？',
        removeRepoMessage: ({ repo }: { repo: string }) => `"${repo}"をHappyから削除してもよろしいですか？GitHubリポジトリは削除されません。`,
        clearSessions: 'ローカルセッションをクリア',
        clearSessionsDesc: 'このリポジトリのすべてのローカルセッションデータを削除します',
        clearSessionsTitle: 'セッションをクリアしますか？',
        clearSessionsMessage: ({ repo }: { repo: string }) => `"${repo}"のすべてのローカルセッションをクリアしてもよろしいですか？この操作は元に戻せません。`,
    },


    repoBinding: {
        cannotProbeTitle: 'パスを確認できません',
        machineOfflineMessage: '対象のマシンはオフラインです。',
        bashFailedMessage: ({ detail }: { detail: string }) => `マシン上でパスを確認できませんでした：${detail || '不明なエラー'}`,
        wrongRemoteTitle: '別のリポジトリ',
        wrongRemoteMessage: ({ found, expected }: { found: string; expected: string }) => `このディレクトリは ${found} のクローンであり、${expected} ではありません。別のパスを選択してください。`,
        dirNotEmptyTitle: 'ディレクトリが空ではありません',
        dirNotEmptyMessage: ({ path }: { path: string }) => `${path} は git リポジトリではなく、ファイルが存在します。空のディレクトリか、まだ存在しないパスを指定してください。`,
        cloneConfirmTitle: ({ slug }: { slug: string }) => `${slug} をクローンしますか？`,
        cloneConfirmMissingMessage: ({ path }: { path: string }) => `${path} はマシン上に存在しません。リポジトリをここにクローンしますか？`,
        cloneConfirmEmptyMessage: ({ path }: { path: string }) => `${path} は空です。リポジトリをこのディレクトリにクローンしますか？`,
        cloneAction: 'クローン',
        cloningTitle: ({ slug }: { slug: string }) => `${slug} をクローン中…`,
        cloningElapsed: ({ seconds }: { seconds: string }) => `${seconds}s`,
        cloningWaiting: 'git の出力を待機中…',
        cloningHint: '初回のクローンには 1 分ほどかかる場合があります。アプリを開いたままにしてください。',
        cloneSucceededTitle: 'クローン成功',
        cloneFailedTitle: 'クローン失敗',
        cloneNoOutput: '（出力なし）',
        cloneFailedHint: 'マシンが GitHub にサインインしていることを確認するか（マシンで `gh auth login` を実行）、手動でクローンしてください。',
    },

    chatSession: {
        cardTitle: 'この Issue について相談',
        cardSubtitle: 'Issue のコンテキストを読み込んだセッションを開く',
        machineUnavailableTitle: 'マシンが利用できません',
        machineUnavailableMessage: 'この Issue について話すには、オンラインのマシンをリポジトリにバインドする必要があります。リポジトリ設定で選択または変更してください。',
        openRepoSettings: 'リポジトリ設定を開く',
    },
    ...
    issueComments: {
        ...
        submit: '送信',
        errorTitle: 'エラー',
        errorReconnect: '更新された権限で GitHub アカウントを再接続してください。',
        errorFallback: 'コメントの送信に失敗しました。',
        takePhoto: '写真を撮る',
        chooseFromAlbum: 'アルバムから選択',
        ...
        deleteConfirmMessage: 'このコメントを削除しますか？この操作は取り消せません。',
        deleteFailed: 'コメントの削除に失敗しました。',
        editFailed: 'コメントの更新に失敗しました。',
    },

    issueDetail: {
        aiSession: 'AIセッションを開始',
    },
    ...
    lab: {
        ...
        screenTitle: 'リポジトリ',
        addRepositoryTitle: 'リポジトリを追加',
        addByUrl: 'URLで追加',
        addByUrlPlaceholder: 'https://github.com/owner/repo',
        directUrl: 'ダイレクトURL',
        invalidGithubUrl: '有効なGitHubリポジトリURLを入力してください',
        invalidGitlabUrl: '有効なGitLabリポジトリURLを入力してください',
        invalidGitUrl: '有効なgitリポジトリURLを入力してください',
        orSelectFromGithub: 'または候補から選択',
        yourGithubRepos: 'おすすめリポジトリ',
        syncFromGithub: 'GitHub から同期',
        selectAll: 'すべて選択',
        addSelected: '選択を追加',
        noGithubRepos: 'GitHub リポジトリが見つかりません',
        searchPlaceholder: 'リポジトリを検索…',
        searchYourRepos: 'リポジトリを検索...',
        emptyTitle: 'リポジトリがありません',
        emptySubtitle: '検索を変えるか、右上の + から URL でリポジトリを追加してください。',
        newSessionShortcut: 'リポジトリ — リモート URL から開始',
        newSessionCardTitle: 'リポジトリ',
        newSessionCardSubtitle: 'URL からリポジトリを開く。ローカルマシン不要',
        cloudMachineAlertTitle: 'クラウド環境',
        cloudMachineStartMessage: 'クラウド環境を起動しています…\n\n（モック: 未実装）',
        cloudMachineStopMessage: 'クラウド環境を停止しています…\n\n（モック: 未実装）',
        alertAddingRepoTitle: 'リポジトリを追加',
        alertRepoAddedTitle: 'リポジトリを追加しました',
        mockNotImplemented: '（モック: 未実装）',
        issueNotFound: 'Issue が見つかりません',
        newIssue: '新しい Issue',
        newPullRequest: 'New Pull Request',
        pullRequestNotFound: 'Pull Request が見つかりません',
        ...
        startAiFixTitle: 'AI 修正を開始',
        retryAiFixTitle: 'AI 修正を再試行',
        newSessionMockTitle: '新しいセッション',
        quickActionAiFixIssues: 'AI で Issue を修正',
        issueRowAiFix: 'AI 修正',
        startCloudEnvironment: 'クラウド環境を起動',
        quickActions: 'クイック操作',
        cloudStop: '停止',
        cloudStart: '起動',
        machinesTab: 'マシン',
        addMachine: 'マシンを追加',
        machineQrTitle: 'コマンドライン',
        machineQrSubtitle: 'happy agent --registerをマシンで実行',
        machineQrRunHint: 'このコマンドをマシンで実行してください：',
        machineQrWaiting: 'エージェントの接続を待機中…',
        machineQrSimulate: '接続をシミュレート',
        machineQrSuccess: 'エージェントが接続されました！',
        machineDockerTitle: 'Docker実行',
        machineDockerSubtitle: 'Happy Agentをコンテナで実行',
        machineDockerCommand: 'docker run happy-agent',
        machineDockerGenerating: 'Dockerコマンドを生成中…',
        machineDockerRunHint: 'このコマンドをコピーしてDockerホストで実行してください：',
        machineDockerWaiting: 'Dockerコンテナの接続を待機中…',
        machineDockerTokenWarning: 'このコマンドには使い捨ての認証トークンが含まれます。今すぐ保存してください — 後から取得することはできません。',
        machineDockerSuccess: 'Dockerエージェントが接続されました！',
        machineServerTitle: 'サーバークラウド',
        machineServerSubtitle: 'サーバーが管理するクラウドマシンを作成',
        machineServerNamePlaceholder: 'マシン名（任意）',
        machineServerCreate: 'サーバーマシンを作成',
        machineServerSuccess: 'サーバークラウドマシンを作成しました！',
        machineCopy: 'コピー',
        machineCopied: 'コマンドをコピーしました',
        machineViewMachine: 'マシンを表示',
        machineRegisterTitle: 'マシンを登録',
        machineRegisterDocker: 'Dockerコマンドを実行',
        machineSectionRecommended: 'おすすめ',
        machineSectionOther: 'その他の方法',
        machineDockerRegenerate: 'コマンドを再生成',
        machineSuccessTitle: 'マシンを登録しました',
        machineSuccessSubtitle: 'エージェントが接続され、使用可能になりました。',
        machineTypeLocal: 'ローカル',
        machineTypeCloud: 'クラウド',
        machinesSelect: '選択',
        machinesDone: '完了',
        machinesDeleteCount: ({ count }: { count: number }) => `削除 (${count})`,
        machinesDeleteOneTitle: 'マシンを削除しますか？',
        machinesDeleteOneMessage: 'このマシンをアカウントから削除します。この操作は取り消せません。',
        machinesDeleteManyTitle: 'マシンを削除しますか？',
        machinesDeleteManyMessage: ({ count }: { count: number }) => `${count} 台のマシンをアカウントから削除しますか？この操作は取り消せません。`,
        machinesDeleteFailed: 'マシンの削除に失敗しました',
        machineStatusOnline: 'オンライン',
        machineStatusOffline: 'オフライン',
        machineCloudProvisioning: 'プロビジョニング中…',
        machineCloudFailedShort: '失敗',
        machineCloudFailed: ({ error }: { error: string }) => `プロビジョニング失敗: ${error}`,
        launchTypeDocker: 'Docker',
        launchTypeCloud: 'サーバークラウド',
    },
