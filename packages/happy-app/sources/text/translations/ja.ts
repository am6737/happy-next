...
export const ja: TranslationStructure = {
    ...
    repoSettings: {
        ...
        machinesFooter: 'セッションとAuto Pilotを有効にするには、マシンにバインドしてください',
        ...
        noMachineAvailableAutoPilot: 'Auto Pilotを使用するには、まず利用可能なマシンでリポジトリを登録してください',
        ...
        notBound: '未バインド',
        notBoundDesc: 'このリポジトリはどのマシンにも登録されていません。バインドするとセッションとAuto Pilotが有効になります。',
        selectMachine: 'マシンを選択',
        ...
        automationEnabledDesc: 'AIによるIssue自動化を有効にする',
        autoPilotNewIssues: '新規Issueの自動修正',
        autoPilotNewIssuesDesc: '新規Issueが作成されたときにAIエージェントを自動的に開始',
        scheduled: 'スケジュール自動修復',
        selectSchedule: 'スケジュールを選択',
        custom: 'カスタム...',
        customCron: 'カスタムCron式',
        customCronMessage: 'Cron式を入力（例：0 * * * * で毎時）',
        customCronHelp: 'Cron形式：分 時 日 月 曜日。例：0 */6 * * * は6時間ごとに実行されます。',
        disabled: '無効',
        triggerLabels: 'トリガーラベル',
        triggerLabelsFooter: 'AIはこれらのラベルを持つIssueのみ自動修正します',
        dangerZone: '危険ゾーン',
        removeRepo: 'リポジトリを削除',
    ...
    lab: {
        sectionTitle: 'ラボ',
        entryTitle: 'リポジトリ',
        entrySubtitle: 'クラウドのリポジトリ、Issue、自動化',
        screenTitle: 'リポジトリ',
        ...
        machineManualTitle: '手動URL',
        machineManualSubtitle: 'カスタムエンドポイントで接続',
        machineManualPlaceholder: 'https://your-machine:3000',
        machineManualConnect: '接続',
        machineManualUrlInvalid: '無効なURL形式',
        machineCopied: 'コマンドをコピーしました',
        machineRegisterTitle: 'マシンを登録',
        machineRegisterQr: 'スキャンして登録',
        machineRegisterDocker: 'Dockerコマンドを実行',
        machineRegisterManual: '手動接続',
