...
export const ja: TranslationStructure = {
    ...
    session: {
        ...
        chooseFile: 'ファイルを選択',
        attachmentDownloadFailed: '添付ファイルをダウンロードできません',
        fileTooLarge: 'ファイルサイズは25 MB以下にしてください',
        tooManyAttachments: '添付できるファイルは10個までです',
        attachmentsUnsupported: 'ファイル添付には新しいCLIが必要です。CLIを更新または再起動して、もう一度お試しください。',
        pasteFromClipboard: 'クリップボードから貼り付け',
        dropImagesToAttach: 'ドロップして画像を添付',
        dropFilesToAttach: 'ドロップしてファイルを添付',
        sharing: {
            title: '共有',
