...
export const ca: TranslationStructure = {
    ...
    session: {
        ...
        attachmentDownloadFailed: 'No s\'ha pogut baixar aquest fitxer adjunt',
        fileTooLarge: 'Els fitxers han de tenir 25 MB o menys',
        tooManyAttachments: 'Pots adjuntar fins a 10 fitxers',
        attachmentsUnsupported: 'Els fitxers adjunts requereixen una CLI actualitzada. Actualitza o reinicia la CLI i torna-ho a provar.',
        pasteFromClipboard: 'Enganxa des del porta-retalls',
        dropImagesToAttach: 'Deixa anar les imatges per adjuntar-les',
        dropFilesToAttach: 'Deixa anar els fitxers per adjuntar-los',
        sharing: {
            title: 'Compartició',
