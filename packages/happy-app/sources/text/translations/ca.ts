...
export const ca: TranslationStructure = {
    ...
    settings: {
        ...
        terminal: 'Terminal',
        terminalSubtitle: 'Obre shells a les teves màquines connectades',
        history: 'History',
    ...
    dootask: {
        ...
        accountLogin: 'Accés amb compte',
        qrLogin: 'Accés amb QR',
        switchToAccount: 'Accés amb compte',
        switchToQr: 'Accés amb QR',
        qrLoginHint: 'Utilitza l’aplicació mòbil de DooTask per escanejar el codi QR i iniciar sessió',
        qrRefresh: 'Toca el codi QR per actualitzar-lo',
    ...
    github: {
        ...
        closed: 'Tancats',
        merged: 'Fusionats',
        searchIssues: 'Cercar incidències...',
        searchPullRequests: 'Cercar pull requests...',
        searchRepos: 'Cercar repositoris...',
        selectRepo: 'Seleccionar repositori',
        switchRepo: 'Canviar repositori',
        findRepo: 'Cercar repositori...',
        pinned: 'Fixats',
        allRepos: 'Tots els repositoris',
        allReposDescription: 'Incidències i pull requests dels teus repositoris',
        assignedToMe: 'Assignades a mi',
        createdByMe: 'Creades per mi',
        reviewRequested: 'Revisió sol·licitada',
        noRepos: 'No s\'han trobat repositoris',
        noIssues: 'No s\'han trobat incidències',
        noPullRequests: 'No s\'han trobat pull requests',
        comments: 'Comentaris',
        aiSession: 'Sessió IA',
        connectFirst: 'Connecta el teu compte de GitHub a Configuració per començar.',
        relatedSessions: 'Sessions relacionades',
    ...
    settingsAppearance: {
        ...
        foldTurnProcess: 'Replega els passos acabats',
        foldTurnProcessDescription: 'Un torn acabat mostra les crides a eines en una línia, que s\'obre en tocar',
    ...
    newSession: {
        ...
        repos: {
            ...
            folderPicker: {
                ...
                inlineConfirmTitle: 'Confirmar ruta de clonació',
                inlineConfirmDescription: 'El repositori es clonarà en aquesta ruta de la màquina.',
                inlineConfirmPathLabel: 'Ruta completa',
                inlineConfirmBrowse: 'Explorar',
                inlineConfirmCancel: 'Cancel·lar',
                inlineConfirmConfirm: 'Confirmar',
                toggleHidden: 'Mostrar carpetes ocultes',
            },
    ...
    sessionInfo: {
        ...
        markerOrange: 'Marcador taronja',
        markerYellow: 'Marcador groc',
        markerGreen: 'Marcador verd',
        markerBlue: 'Marcador blau',
        markerPurple: 'Marcador porpra',
        ...
        delegationHistory: 'Historial de delegacions',
        delegationHistorySubtitle: 'Consulta les tasques delegades iniciades des d’aquesta conversa i el seu estat',
        ...
        updateCliInstructions: 'Si us plau executeu happy update',
    ...
    tools: {
        ...
        names: {
            ...
            question: 'Pregunta',
            previewHtml: 'Previsualització HTML',
        },
        desc: {
        ...
        plan: {
            expand: 'Veure el pla complet',
            collapse: 'Mostra\'n menys',
        },
        askUserQuestion: {
    ...
    repository: {
        ...
        pulls: 'Pull Requests',
        sessions: 'Sessions',
        settings: 'Configuració del repositori',
        private: 'Privat',
        public: 'Públic',
        updatedAgo: ({ time }: { time: string }) => `Actualitzat ${time}`,
        liveSessions: ({ count }: { count: number }) => `${count} actives`,
        ...
        noContributors: 'Encara no hi ha col·laboradors',
        ...
        emptyIssuesSubtitle: 'Obre un issue per fer seguiment d\'errors o idees.',
        ...
        selectedCount: ({ count }: { count: number }) => `${count} seleccionat${count !== 1 ? 's' : ''}`,
        batchDelete: 'Eliminar',
        batchArchive: 'Arxivar',
        batchDeleteConfirm: ({ count }: { count: number }) => `Eliminar ${count} sessió${count !== 1 ? 'ns' : ''}?`,
        batchDeleteWarning: 'Aquesta acció no es pot desfer. Tots els missatges i dades associats a aquestes sessions s\'eliminaran permanentment.',
        batchArchiveConfirm: ({ count }: { count: number }) => `Arxivar ${count} sessió${count !== 1 ? 'ns' : ''}?`,
        batchArchiveWarning: 'Aquestes sessions s\'aturaran i arxivaran.',
        batchDeleteFailed: ({ count }: { count: number }) => `Error en eliminar ${count} sessió${count !== 1 ? 'ns' : ''}`,
        batchArchiveFailed: ({ count }: { count: number }) => `Error en arxivar ${count} sessió${count !== 1 ? 'ns' : ''}`,
        readmoreReadme: 'Read full README',
        issueStatus: 'Estat',
        issueAuthor: 'Autor',
        issueLabels: 'Etiquetes',
        issueCreated: 'Creat',
        issueDescription: 'Descripció',
        noDescription: 'No s\'ha proporcionat cap descripció.',
        copyPrUrl: 'Copiar URL del PR',
        copyPrNumber: 'Copiar número de PR',
        prBranch: 'Branca',
        prMerged: 'Fusionat',
        closePr: 'Tancar Pull Request',
        reopenPr: 'Reobrir Pull Request',
        copyIssueUrl: 'Copiar URL de la incidència',
        openInGithub: 'Obrir a GitHub',
        copyIssueNumber: 'Copiar número de la incidència',
        closeIssue: 'Tancar incidència',
        reopenIssue: 'Reobrir incidència',
        updateStateFailed: 'No s\'ha pogut actualitzar l\'estat.',
    },
    ...
    modals: {
        ...
        reviewDemoQrScannedSuccessfully: 'El codi QR de demostració per a la revisió s\'ha escanejat correctament. L\'escàner QR funciona correctament.'
    },
    ...
    repoSettings: {
        ...
        public: 'Públic',
        private: 'Privat',
        defaultBranch: 'Branca per defecte',
        language: 'Llenguatge',
        lastPush: 'Últim push',
        repoSize: 'Mida',
        github: 'GitHub',
        ...
        installGithubApp: 'Instal·lar GitHub App',
        installGithubAppDesc: 'Necessari per a l\'automatització basada en webhooks',
        githubAppInstalled: 'GitHub App instal·lada',
        machines: 'Màquines i directoris de treball',
        machinesFooter: 'Vinculeu aquest repositori a una màquina per a sessions i pilot automàtic',
        noMachinesRegistered: 'No hi ha màquines registrades',
        noMachinesAvailable: 'No hi ha màquines disponibles. Afegeix una màquina primer.',
        machineOffline: 'fora de línia',
        machineOnline: 'en línia',
        noMachineAvailable: 'No hi ha màquines disponibles',
        noMachineAvailableNewSession: 'Registra aquest repositori en una màquina per crear sessions',
        noMachineAvailableAutoPilot: 'Register this repository on an available machine',
        registerRepoOnMachine: 'Registra en aquesta màquina',
        repoAlreadyRegistered: 'Aquest repositori ja està registrat en aquesta màquina',
        machineOfflineCannotRegister: 'La màquina està fora de línia. Posala en línia per registrar.',
        notBound: 'No vinculat',
        notBoundDesc: 'Aquest repositori no està registrat a cap màquina. Vinculeu-lo per habilitar sessions i pilot automàtic.',
        selectMachine: 'Selecciona màquina',
        changeMachine: 'Canvia màquina',
        unbindMachine: 'Desvincula',
        unbindAction: 'Desvincula',
        unbindConfirmTitle: 'Desvincular màquina?',
        unbindConfirmMessage: ({ repo }: { repo: string }) => `Desvincular ${repo}? Les sessions existents a la màquina es mantenen; pots tornar a vincular més tard.`,
        confirmPath: 'Confirmar camí',
        parentPath: 'Camí pare',
        bindingRepoName: 'Nom del repositori',
        fullPath: 'Camí complet',
        fullPathPlaceholder: '/Users/xxx/projects/repo-name',
        pathAlreadyExists: 'Aquest camí ja existeix. Trieu un nom o camí diferent.',
        workingDir: 'Directori de treball',
        targetBranch: 'Branca destí',
        disabled: 'Disabled',
        custom: 'Custom...',
        customCronHelp: 'Cron format: minute hour day-of-month month day-of-week. Example: 0 */6 * * * runs every 6 hours.',
        selectSchedule: 'Seleccionar horari',
        dangerZone: 'Zona de perill',
        removeRepo: 'Eliminar repositori',
        removeRepoDesc: 'Eliminar aquest repositori de Happy. No eliminarà el repositori GitHub.',
        removeRepoTitle: 'Eliminar repositori?',
        removeRepoMessage: ({ repo }: { repo: string }) => `Estàs segur que vols eliminar "${repo}" de Happy? No eliminarà el repositori GitHub.`,
        clearSessions: 'Esborrar sessions locals',
        clearSessionsDesc: 'Eliminar totes les dades de sessions locals per a aquest repositori',
        clearSessionsTitle: 'Esborrar sessions?',
        clearSessionsMessage: ({ repo }: { repo: string }) => `Estàs segur que vols esborrar totes les sessions locals per a "${repo}"? Aquesta acció no es pot desfer.`,
    },


    repoBinding: {
        cannotProbeTitle: 'No es pot inspeccionar la ruta',
        machineOfflineMessage: 'La màquina de destinació està fora de línia.',
        bashFailedMessage: ({ detail }: { detail: string }) => `No s\'ha pogut inspeccionar la ruta a la màquina: ${detail || 'error desconegut'}`,
        wrongRemoteTitle: 'Repositori diferent',
        wrongRemoteMessage: ({ found, expected }: { found: string; expected: string }) => `Aquest directori és un clon de ${found}, no de ${expected}. Tria una altra ruta.`,
        dirNotEmptyTitle: 'Directori no buit',
        dirNotEmptyMessage: ({ path }: { path: string }) => `${path} no és un repositori git i conté fitxers. Tria un directori buit o una ruta que encara no existeixi.`,
        cloneConfirmTitle: ({ slug }: { slug: string }) => `Clonar ${slug}?`,
        cloneConfirmMissingMessage: ({ path }: { path: string }) => `${path} no existeix a la màquina. Clonar el repositori aquí?`,
        cloneConfirmEmptyMessage: ({ path }: { path: string }) => `${path} és buit. Clonar el repositori en aquest directori?`,
        cloneAction: 'Clona',
        cloningTitle: ({ slug }: { slug: string }) => `Clonant ${slug}…`,
        cloningElapsed: ({ seconds }: { seconds: string }) => `${seconds} s`,
        cloningWaiting: 'Esperant la sortida de git…',
        cloningHint: 'La primera clonació pot trigar un minut. Mantén l\'aplicació oberta.',
        cloneSucceededTitle: 'Clonació correcta',
        cloneFailedTitle: 'Ha fallat la clonació',
        cloneNoOutput: '(sense sortida)',
        cloneFailedHint: 'Assegura\'t que la màquina ha iniciat sessió a GitHub (executa `gh auth login` a la màquina) o clona manualment.',
    },

    chatSession: {
        cardTitle: 'Parla sobre aquest issue',
        cardSubtitle: 'Obre una sessió precarregada amb el context de l\'issue',
        machineUnavailableTitle: 'Màquina no disponible',
        machineUnavailableMessage: 'Per discutir aquest issue cal una màquina en línia vinculada al repositori. Obre la configuració del repositori per seleccionar-la o canviar-la.',
        openRepoSettings: 'Obrir ajustos del repo',
    },
    ...
    issueComments: {
        ...
        submit: 'Comenta',
        errorTitle: 'Error',
        errorReconnect: 'Torna a connectar el teu compte de GitHub amb permisos actualitzats.',
        errorFallback: 'No s\'ha pogut publicar el comentari.',
        takePhoto: 'Fer foto',
        chooseFromAlbum: 'Triar de l\'àlbum',
        ...
        edit: 'Edita',
        delete: 'Suprimeix',
        editing: 'Editant comentari…',
        deleteConfirmTitle: 'Suprimeix comentari',
        deleteConfirmMessage: 'Segur que vols suprimir aquest comentari? Això no es pot desfer.',
        deleteFailed: 'No s\'ha pogut suprimir el comentari.',
        editFailed: 'No s\'ha pogut actualitzar el comentari.',
    },

    issueDetail: {
        aiSession: 'Iniciar sessió IA',
    },
    ...
    lab: {
        ...
        cloudStop: 'Stop',
        cloudStart: 'Start',
        machinesTab: 'Màquines',
        addMachine: 'Afegir màquina',
        machineQrTitle: 'Línia d\'ordres',
        machineQrSubtitle: 'Executa happy agent --register a la teva màquina',
        machineQrRunHint: 'Executa aquesta ordre a la teva màquina:',
        machineQrWaiting: 'Esperant que l\'agent es connecti…',
        machineQrSimulate: 'Simular connexió',
        machineQrSuccess: 'Agent connectat!',
        machineDockerTitle: 'Docker Run',
        machineDockerSubtitle: 'Executa Happy Agent en un contenidor',
        machineDockerCommand: 'docker run happy-agent',
        machineDockerGenerating: 'Generant l\'ordre Docker…',
        machineDockerRunHint: 'Copia i executa aquesta ordre al teu host Docker:',
        machineDockerWaiting: 'Esperant que el contenidor Docker es connecti…',
        machineDockerTokenWarning: 'L\'ordre conté un token d\'un sol ús. Guarda\'l ara — no es podrà recuperar després.',
        machineDockerSuccess: 'Agent Docker connectat!',
        machineServerTitle: 'Server Cloud',
        machineServerSubtitle: 'Crea una màquina al núvol gestionada pel servidor',
        machineServerNamePlaceholder: 'Nom de la màquina (opcional)',
        machineServerCreate: 'Crear màquina de servidor',
        machineServerSuccess: 'Màquina al núvol creada!',
        machineCopy: 'Copia',
        machineCopied: 'Comanda copiada',
        machineViewMachine: 'Veure màquina',
        machineRegisterTitle: 'Registrar màquina',
        machineRegisterDocker: 'Executa comanda Docker',
        machineSectionRecommended: 'Recomanat',
        machineSectionOther: 'Altres mètodes',
        machineDockerRegenerate: 'Regenera la comanda',
        machineSuccessTitle: 'Màquina registrada',
        machineSuccessSubtitle: 'El teu agent està connectat i a punt.',
        machineTypeLocal: 'Local',
        machineTypeCloud: 'Núvol',
        machinesSelect: 'Selecciona',
        machinesDone: 'Fet',
        machinesDeleteCount: ({ count }: { count: number }) => `Elimina (${count})`,
        machinesDeleteOneTitle: 'Eliminar la màquina?',
        machinesDeleteOneMessage: "S'eliminarà aquesta màquina del teu compte. Aquesta acció no es pot desfer.",
        machinesDeleteManyTitle: 'Eliminar màquines?',
        machinesDeleteManyMessage: ({ count }: { count: number }) => `Eliminar ${count} màquines del teu compte? Aquesta acció no es pot desfer.`,
        machinesDeleteFailed: 'No s\'ha pogut eliminar la màquina',
        machineStatusOnline: 'En línia',
        machineStatusOffline: 'Fora de línia',
        machineCloudProvisioning: 'Aprovisionant…',
        machineCloudFailedShort: 'Error',
        machineCloudFailed: ({ error }: { error: string }) => `Error en aprovisionar: ${error}`,
