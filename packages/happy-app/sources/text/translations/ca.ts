...
export const ca: TranslationStructure = {
    ...
    repoSettings: {
        ...
        lastPush: 'Últim push',
        repoSize: 'Mida',
        githubSync: 'Sincronització GitHub',
        ...
        noMachineAvailableAutoPilot: 'Registra aquest repositori en una màquina disponible per fer servir Auto Pilot',
        ...
        automationEnabled: 'Automatització activada',
        automationEnabledDesc: 'Activar automatització d\'incidències amb IA',
        autoPilotNewIssues: 'Auto-reparar noves incidències',
        autoPilotNewIssuesDesc: 'Iniciar automàticament l\'agent IA en crear noves incidències',
        scheduled: 'Auto Pilot Programat',
        selectSchedule: 'Seleccionar programació',
        custom: 'Personalitzat...',
        customCron: 'Expressió cron personalitzada',
        customCronMessage: 'Introduïu una expressió cron (p. ex. 0 * * * * per cada hora)',
        customCronHelp: 'Format cron: minut hora dia-mes mes dia-setmana. Exemple: 0 */6 * * * s\'executa cada 6 hores.',
        disabled: 'Desactivat',
        triggerLabels: 'Etiquetes d\'activació',
        triggerLabelsFooter: 'La IA només auto-repararà incidències amb aquestes etiquetes',
        dangerZone: 'Zona de perill',
    ...
    lab: {
        ...
        entrySubtitle: 'Cloud repositories, issues & automation',
        ...
        addMachine: 'Afegir màquina',
        machineQrTitle: 'Escaneja codi QR',
        ...
        machineManualTitle: 'URL manual',
        machineManualSubtitle: 'Connecta via un endpoint personalitzat',
        machineManualPlaceholder: 'https://your-machine:3000',
        machineManualConnect: 'Connecta',
        machineManualUrlInvalid: 'Format d\'URL invàlid',
        machineCopied: 'Comanda copiada',
        machineRegisterTitle: 'Registrar màquina',
        machineRegisterQr: 'Escaneja per registrar',
        machineRegisterDocker: 'Executa comanda Docker',
        machineRegisterManual: 'Connexió manual',
