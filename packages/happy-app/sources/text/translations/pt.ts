...
export const pt: TranslationStructure = {
    ...
    session: {
        ...
        attachmentDownloadFailed: 'Não foi possível baixar este anexo',
        fileTooLarge: 'Os arquivos devem ter no máximo 25 MB',
        tooManyAttachments: 'Você pode anexar até 10 arquivos',
        attachmentsUnsupported: 'Os anexos exigem uma CLI atualizada. Atualize ou reinicie a CLI e tente novamente.',
