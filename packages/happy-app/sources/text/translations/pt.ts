...
export const pt: TranslationStructure = {
    ...
    repoSettings: {
        ...
        repoSize: 'Tamanho',
        githubSync: 'Sincronização GitHub',
        ...
        noMachineAvailableAutoPilot: 'Registre este repositório em uma máquina disponível para usar Auto Pilot',
        ...
        automationEnabledDesc: 'Habilitar automação de issues com IA',
        autoPilotNewIssues: 'Auto-corrigir novos issues',
        autoPilotNewIssuesDesc: 'Iniciar automaticamente o agente IA quando novos issues forem criados',
        scheduled: 'Auto Pilot Agendado',
        selectSchedule: 'Selecionar agendamento',
        custom: 'Personalizado...',
        customCron: 'Expressão cron personalizada',
        customCronMessage: 'Digite uma expressão cron (ex. 0 * * * * para cada hora)',
        customCronHelp: 'Formato cron: minuto hora dia-mês mês dia-semana. Exemplo: 0 */6 * * * é executado a cada 6 horas.',
        disabled: 'Desabilitado',
        triggerLabels: 'Labels de gatilho',
        triggerLabelsFooter: 'A IA só auto-corrigirá issues com essas labels',
    ...
    lab: {
        ...
        addMachine: 'Adicionar máquina',
        machineQrTitle: 'Escanear código QR',
        ...
        machineManualSubtitle: 'Conectar via endpoint personalizado',
        machineManualPlaceholder: 'https://your-machine:3000',
        machineManualConnect: 'Conectar',
        machineManualUrlInvalid: 'Formato de URL inválido',
        machineCopied: 'Comando copiado',
        machineRegisterTitle: 'Registrar máquina',
        machineRegisterQr: 'Escanear para registrar',
        machineRegisterDocker: 'Executar comando Docker',
        machineRegisterManual: 'Conexão manual',
