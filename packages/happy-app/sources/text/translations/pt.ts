...
export const pt: TranslationStructure = {
    ...
    settings: {
        ...
        terminal: 'Terminal',
        terminalSubtitle: 'Abra shells nas suas máquinas conectadas',
        history: 'History',
    ...
    dootask: {
        ...
        accountLogin: 'Entrar com a conta',
        qrLogin: 'Entrar com código QR',
        switchToAccount: 'Entrar com a conta',
        switchToQr: 'Entrar com código QR',
        qrLoginHint: 'Use o aplicativo móvel do DooTask para escanear o código QR e entrar',
        qrRefresh: 'Toque no código QR para atualizá-lo',
    ...
    github: {
        ...
        searchPullRequests: 'Pesquisar pull requests...',
        searchRepos: 'Pesquisar repositórios...',
        selectRepo: 'Selecionar repositório',
        switchRepo: 'Trocar repositório',
        findRepo: 'Encontrar repositório...',
        pinned: 'Fixados',
        allRepos: 'Todos os repositórios',
        allReposDescription: 'Problemas e pull requests nos seus repositórios',
        ...
        noPullRequests: 'Nenhum pull request encontrado',
        comments: 'Comentários',
        aiSession: 'Sessão IA',
        connectFirst: 'Conecte sua conta GitHub nas Configurações para começar.',
        relatedSessions: 'Sessões relacionadas',
    ...
    settingsAppearance: {
        ...
        foldTurnProcess: 'Recolher os passos concluídos',
        foldTurnProcessDescription: 'Um turno concluído mostra as chamadas de ferramentas numa linha, que abre ao tocar',
    ...
    newSession: {
        ...
        repos: {
            ...
            folderPicker: {
                ...
                inlineConfirmTitle: 'Confirmar caminho de clone',
                inlineConfirmDescription: 'O repositório será clonado neste caminho na máquina.',
                inlineConfirmPathLabel: 'Caminho completo',
                inlineConfirmBrowse: 'Procurar',
                inlineConfirmCancel: 'Cancelar',
                inlineConfirmConfirm: 'Confirmar',
                toggleHidden: 'Mostrar pastas ocultas',
            },
    ...
    sessionInfo: {
        ...
        markerOrange: 'Marcador laranja',
        markerYellow: 'Marcador amarelo',
        markerGreen: 'Marcador verde',
        markerBlue: 'Marcador azul',
        markerPurple: 'Marcador roxo',
        markerGray: 'Marcador cinzento',
        ...
        newSession: 'Nova sessão',
        newSessionSubtitle: 'Inicie uma nova sessão usando a máquina e o diretório de trabalho atuais',
        openTerminal: 'Terminal',
        openTerminalSubtitle: 'Abrir um shell no diretório de trabalho desta sessão',
        revealInFinder: 'Mostrar no Finder',
        revealInFolder: 'Mostrar na pasta',
        revealInFileManagerFailed: 'Não foi possível mostrar esta pasta',
        delegationHistory: 'Histórico de delegações',
        delegationHistorySubtitle: 'Veja as tarefas delegadas iniciadas nesta conversa e seus status',
        ...
        updateCliInstructions: 'Por favor execute happy update',
    ...
    agentInput: {
        ...
        context: {
            ...
            details: ({ usedPercent, remainingPercent, usedTokens, totalTokens }: { usedPercent: number; remainingPercent: number; usedTokens: string; totalTokens: string }) => `Janela de contexto:\n${usedPercent}% usado (${remainingPercent}% restante)\n${usedTokens} tokens usados, ${totalTokens} no total`,
        },
        suggestion: {
            fileLabel: 'ARQUIVO',
            folderLabel: 'PASTA',
    ...
    tools: {
        ...
        names: {
            ...
            question: 'Pergunta',
            previewHtml: 'Pré-visualização HTML',
        },
        desc: {
    ...
    repository: {
        ...
        private: 'Privado',
        public: 'Público',
        updatedAgo: ({ time }: { time: string }) => `Atualizado ${time}`,
        liveSessions: ({ count }: { count: number }) => `${count} ativas`,
        ...
        noContributors: 'Ainda não há colaboradores',
        ...
        emptyIssuesSubtitle: 'Abra um issue para rastrear bugs ou ideias.',
        ...
        selectedCount: ({ count }: { count: number }) => `${count} selecionado${count !== 1 ? 's' : ''}`,
        batchDelete: 'Excluir',
        batchArchive: 'Arquivar',
        batchDeleteConfirm: ({ count }: { count: number }) => `Excluir ${count} sessão${count !== 1 ? 'ões' : ''}?`,
        batchDeleteWarning: 'Esta ação não pode ser desfeita. Todas as mensagens e dados associados a essas sessões serão excluídos permanentemente.',
        batchArchiveConfirm: ({ count }: { count: number }) => `Arquivar ${count} sessão${count !== 1 ? 'ões' : ''}?`,
        batchArchiveWarning: 'Essas sessões serão paradas e arquivadas.',
        batchDeleteFailed: ({ count }: { count: number }) => `Falha ao excluir ${count} sessão${count !== 1 ? 'ões' : ''}`,
        batchArchiveFailed: ({ count }: { count: number }) => `Falha ao arquivar ${count} sessão${count !== 1 ? 'ões' : ''}`,
        ...
        copyPrUrl: 'Copiar URL do PR',
        copyPrNumber: 'Copiar número do PR',
        prBranch: 'Branch',
        prMerged: 'Mesclado',
        closePr: 'Fechar Pull Request',
        reopenPr: 'Reabrir Pull Request',
        copyIssueUrl: 'Copiar URL da issue',
        openInGithub: 'Abrir no GitHub',
        copyIssueNumber: 'Copiar número da issue',
        closeIssue: 'Fechar issue',
        reopenIssue: 'Reabrir issue',
        updateStateFailed: 'Falha ao atualizar o status.',
    },
    ...
    terminalSession: {
        title: 'Terminal',
        openFailed: 'Não foi possível abrir um terminal',
        empty: 'Nenhum terminal aberto',
        newTerminal: 'Novo terminal',
        machineOffline: 'Máquina offline · o ecrã parou de atualizar',
        duplicateTerminal: 'Duplicar terminal',
        closeTerminal: 'Fechar terminal',
        renameTerminalHint: 'Dê a este terminal um nome próprio. Deixe vazio para voltar ao que tem.',
        duplicateFailed: 'Não foi possível duplicar o terminal',
        closeTab: ({ label }: { label: string }) => `Fechar ${label}`,
    },
    ...
    repoSettings: {
        ...
        installGithubAppDesc: 'Necessário para automação baseada em webhooks',
        githubAppInstalled: 'GitHub App instalado',
        machines: 'Máquinas e diretórios de trabalho',
        machinesFooter: 'Vincule este repositório a uma máquina para sessões e piloto automático',
        noMachinesRegistered: 'Nenhuma máquina registrada',
        noMachinesAvailable: 'Nenhuma máquina disponível. Adicione uma máquina primeiro.',
        machineOffline: 'offline',
        machineOnline: 'online',
        noMachineAvailable: 'Nenhuma máquina disponível',
        noMachineAvailableNewSession: 'Registre este repositório em uma máquina para criar sessões',
        noMachineAvailableAutoPilot: 'Register this repository on an available machine',
        registerRepoOnMachine: 'Registrar nesta máquina',
        repoAlreadyRegistered: 'Este repositório já está registrado nesta máquina',
        machineOfflineCannotRegister: 'A máquina está offline. Conecte-se para registrar.',
        notBound: 'Não vinculado',
        notBoundDesc: 'Este repositório não está registrado em nenhuma máquina. Vincule-o para habilitar sessões e piloto automático.',
        selectMachine: 'Selecionar máquina',
        changeMachine: 'Mudar máquina',
        unbindMachine: 'Desvincular',
        unbindAction: 'Desvincular',
        unbindConfirmTitle: 'Desvincular máquina?',
        unbindConfirmMessage: ({ repo }: { repo: string }) => `Desvincular ${repo}? As sessões existentes na máquina são mantidas; você pode vincular novamente mais tarde.`,
        confirmPath: 'Confirmar caminho',
        parentPath: 'Caminho pai',
        bindingRepoName: 'Nome do repositório',
        fullPath: 'Caminho completo',
        fullPathPlaceholder: '/Users/xxx/projects/repo-name',
        pathAlreadyExists: 'Este caminho já existe. Escolha um nome ou caminho diferente.',
        ...
        selectSchedule: 'Selecionar agendamento',
        dangerZone: 'Zona de perigo',
        removeRepo: 'Remover repositório',
        removeRepoDesc: 'Remover este repositório do Happy. Isso não excluirá o repositório GitHub.',
        removeRepoTitle: 'Remover repositório?',
        removeRepoMessage: ({ repo }: { repo: string }) => `Tem certeza de que deseja remover "${repo}" do Happy? O repositório GitHub não será excluído.`,
        clearSessions: 'Limpar sessões locais',
        clearSessionsDesc: 'Excluir todos os dados de sessões locais para este repositório',
        clearSessionsTitle: 'Limpar sessões?',
        clearSessionsMessage: ({ repo }: { repo: string }) => `Tem certeza de que deseja limpar todas as sessões locais para "${repo}"? Esta ação não pode ser desfeita.`,
    },


    repoBinding: {
        cannotProbeTitle: 'Não foi possível inspecionar o caminho',
        machineOfflineMessage: 'A máquina alvo está offline.',
        bashFailedMessage: ({ detail }: { detail: string }) => `Falha ao inspecionar o caminho na máquina: ${detail || 'erro desconhecido'}`,
        wrongRemoteTitle: 'Repositório diferente',
        wrongRemoteMessage: ({ found, expected }: { found: string; expected: string }) => `Este diretório é um clone de ${found}, não de ${expected}. Escolha outro caminho.`,
        dirNotEmptyTitle: 'Diretório não vazio',
        dirNotEmptyMessage: ({ path }: { path: string }) => `${path} não é um repositório git e contém arquivos. Escolha um diretório vazio ou um caminho que ainda não exista.`,
        cloneConfirmTitle: ({ slug }: { slug: string }) => `Clonar ${slug}?`,
        cloneConfirmMissingMessage: ({ path }: { path: string }) => `${path} não existe na máquina. Clonar o repositório aqui?`,
        cloneConfirmEmptyMessage: ({ path }: { path: string }) => `${path} está vazio. Clonar o repositório neste diretório?`,
        cloneAction: 'Clonar',
        cloningTitle: ({ slug }: { slug: string }) => `Clonando ${slug}…`,
        cloningElapsed: ({ seconds }: { seconds: string }) => `${seconds} s`,
        cloningWaiting: 'Aguardando saída do git…',
        cloningHint: 'A primeira clonagem pode levar um minuto. Mantenha o app aberto.',
        cloneSucceededTitle: 'Clonagem bem-sucedida',
        cloneFailedTitle: 'Falha ao clonar',
        cloneNoOutput: '(sem saída)',
        cloneFailedHint: 'Certifique-se de que a máquina está autenticada no GitHub (execute `gh auth login` na máquina) ou clone manualmente.',
    },

    chatSession: {
        cardTitle: 'Conversar sobre este issue',
        cardSubtitle: 'Abra uma sessão pré-carregada com o contexto do issue',
        machineUnavailableTitle: 'Máquina indisponível',
        machineUnavailableMessage: 'Para discutir este issue é necessária uma máquina online vinculada ao repositório. Abra as configurações do repositório para selecionar ou alterar uma.',
        openRepoSettings: 'Abrir configurações do repo',
    },
    ...
    issueComments: {
        ...
        submit: 'Comentar',
        errorTitle: 'Erro',
        errorReconnect: 'Por favor, reconecte sua conta do GitHub com permissões atualizadas.',
        errorFallback: 'Falha ao publicar o comentário.',
        takePhoto: 'Tirar foto',
        chooseFromAlbum: 'Escolher do álbum',
        ...
        edit: 'Editar',
        delete: 'Excluir',
        editing: 'Editando comentário…',
        deleteConfirmTitle: 'Excluir comentário',
        deleteConfirmMessage: 'Tem certeza de que deseja excluir este comentário? Isso não pode ser desfeito.',
        deleteFailed: 'Falha ao excluir comentário.',
        editFailed: 'Falha ao atualizar comentário.',
    },

    issueDetail: {
        aiSession: 'Iniciar sessão IA',
    },
    ...
    lab: {
        ...
        addMachine: 'Adicionar máquina',
        machineQrTitle: 'Linha de comando',
        machineQrSubtitle: 'Execute happy agent --register na sua máquina',
        machineQrRunHint: 'Execute este comando na sua máquina:',
        machineQrWaiting: 'Aguardando a conexão do agente…',
        machineQrSimulate: 'Simular conexão',
        machineQrSuccess: 'Agente conectado!',
        machineDockerTitle: 'Docker Run',
        machineDockerSubtitle: 'Execute Happy Agent em um contêiner',
        machineDockerCommand: 'docker run happy-agent',
        machineDockerGenerating: 'Gerando comando Docker…',
        machineDockerRunHint: 'Copie e execute este comando no seu host Docker:',
        machineDockerWaiting: 'Aguardando o contêiner Docker conectar…',
        machineDockerTokenWarning: 'O comando contém um token de uso único. Salve agora — não será possível recuperá-lo depois.',
        machineDockerSuccess: 'Agente Docker conectado!',
        machineServerTitle: 'Server Cloud',
        machineServerSubtitle: 'Crie uma máquina em nuvem gerenciada pelo servidor',
        machineServerNamePlaceholder: 'Nome da máquina (opcional)',
        machineServerCreate: 'Criar máquina de servidor',
        machineServerSuccess: 'Máquina em nuvem criada!',
        machineCopy: 'Copiar',
        machineCopied: 'Comando copiado',
        machineViewMachine: 'Ver máquina',
        machineRegisterTitle: 'Registrar máquina',
        machineRegisterDocker: 'Executar comando Docker',
        machineSectionRecommended: 'Recomendado',
        machineSectionOther: 'Outros métodos',
        machineDockerRegenerate: 'Regenerar comando',
        machineSuccessTitle: 'Máquina registrada',
        machineSuccessSubtitle: 'Seu agente está conectado e pronto para uso.',
        machineTypeLocal: 'Local',
        machineTypeCloud: 'Nuvem',
        machinesSelect: 'Selecionar',
        machinesDone: 'Concluído',
        machinesDeleteCount: ({ count }: { count: number }) => `Excluir (${count})`,
        machinesDeleteOneTitle: 'Excluir máquina?',
        machinesDeleteOneMessage: 'Esta máquina será removida da sua conta. Esta ação não pode ser desfeita.',
        machinesDeleteManyTitle: 'Excluir máquinas?',
        machinesDeleteManyMessage: ({ count }: { count: number }) => `Remover ${count} máquinas da sua conta? Esta ação não pode ser desfeita.`,
        machinesDeleteFailed: 'Falha ao excluir máquina',
        machineStatusOnline: 'Online',
        machineStatusOffline: 'Offline',
        machineCloudProvisioning: 'Provisionando…',
        machineCloudFailedShort: 'Falha',
        machineCloudFailed: ({ error }: { error: string }) => `Falha ao provisionar: ${error}`,
    ...
    message: {
        ...
        stopVoice: 'Parar voz',
        queuedVoice: 'Na fila de leitura — toque para remover',
        compactSummaryPlaceholder: ({ chars }: { chars: number }) => `Contexto compactado (${chars} caracteres). Toque para ver.`,
        tooLongPlaceholder: ({ chars }: { chars: number }) => `Mensagem longa (${chars} caracteres). Toque para ver.`,
    },

    tts: {
        queueTitle: 'Fila de leitura',
        stopCurrent: 'Parar esta mensagem',
        removeFromQueue: 'Remover da fila',
        showQueue: 'Mostrar fila de leitura',
    },
