...
export const zhHans: TranslationStructure = {
    ...
    dootask: {
        ...
        accountLogin: '账号登录',
        qrLogin: '扫码登录',
        switchToAccount: '账号登录',
        switchToQr: '扫码登录',
        qrLoginHint: '使用 DooTask 移动端扫描二维码登录',
        qrRefresh: '点击二维码刷新',
    ...
    github: {
        ...
        pinned: '已置顶',
        allRepos: '全部仓库',
        allReposDescription: '跨仓库查看议题和拉取请求',
        assignedToMe: '分配给我',
        createdByMe: '由我创建',
        reviewRequested: '待我审查',
        noRepos: '未找到仓库',
        noIssues: '未找到议题',
        noPullRequests: '未找到拉取请求',
        comments: '评论',
        aiSession: 'AI 会话',
        connectFirst: '请在设置中连接你的 GitHub 账户以开始使用。',
        relatedSessions: '相关会话',
    ...
    settingsAppearance: {
        ...
        foldTurnProcess: '折叠已结束的过程',
        foldTurnProcessDescription: '已结束的回合把工具调用收成一行，点一下展开',
    ...
    settingsDesktop: {
        ...
        diagnosticsTitle: '桌面端诊断',
        diagnosticsSubtitle: '查看连接、构建和日志信息',
    },
    desktopUpdate: {
        title: '软件更新',
        settingsSubtitle: '检查并安装桌面客户端更新',
        footer: '更新文件从 Happy Next 官方 GitHub Releases 下载，并在安装前验证签名。',
        currentVersion: '当前版本',
        status: '更新状态',
        notChecked: '尚未检查',
        checking: '正在检查更新…',
        upToDate: 'Happy Next 已是最新版本',
        available: ({ version }: { version: string }) => `发现新版本 ${version}`,
        downloading: '正在下载更新…',
        downloadingProgress: ({ progress }: { progress: number }) => `正在下载… ${progress}%`,
        ready: '已下载，等待重启更新',
        installing: '正在安装更新…',
        productionOnly: '仅正式版支持检查更新',
        failed: '更新失败',
        releaseNotes: '更新内容',
        checkNow: '检查更新',
        download: '下载更新',
        ...
        readyTitle: '更新已准备好',
        readyMessage: '重新启动 Happy Next 即可完成更新。',
        restartNow: '重启并更新',
        restartLater: '稍后重启',
        later: '暂不更新',
        tryAgain: '请检查网络，然后前往“设置 → 软件更新”重试。',
    },
    desktopDiagnostics: {
        title: '桌面端诊断',
        subtitle: '查看连接、构建和日志信息',
        overview: '概览',
        version: '版本',
        platform: '平台',
        build: '构建类型',
        ...
        reachable: '服务器响应正常',
        unreachable: '无法连接服务器',
        privacyFooter: '诊断信息不包含登录凭证、消息内容或个人资料数据。',
    },
    ...
    newSession: {
        ...
        repos: {
            ...
            folderPicker: {
                ...
                gitRepo: 'Git 仓库',
                selectFile: '选择文件',
                inlineConfirmTitle: '确认克隆路径',
                inlineConfirmDescription: '仓库将被克隆到该机器上的此路径。',
                inlineConfirmPathLabel: '完整路径',
                inlineConfirmBrowse: '浏览',
                inlineConfirmCancel: '取消',
                inlineConfirmConfirm: '确认',
                toggleHidden: '显示隐藏目录',
            },
            targetBranch: '目标分支',
        },
    ...
    commandPalette: {
        placeholder: '输入命令或搜索...',
        noResults: '没有匹配的命令或会话',
        actionFailed: '命令执行失败，请重试',
        searchingMessages: '正在搜索本地消息…',
        messageMatch: '消息',
        resultCount: ({ count }: { count: number }) => `${count} 个结果`,
        navigateHint: '↑↓ 移动',
        selectHint: '↵ 选择',
        closeHint: 'esc 关闭',
        categoryQuickActions: '快捷操作',
        categoryCurrentSession: '当前会话',
        categorySessions: '会话',
        categoryNavigation: '页面导航',
        categorySystem: '系统',
        sessionsSubtitle: '浏览活跃和最近的会话',
        inboxSubtitle: '打开消息和通知',
        dootaskSubtitle: '打开任务和项目',
        newDootaskTask: '新建 DooTask 任务',
        newDootaskProject: '新建 DooTask 项目',
        statusRunning: '运行中',
        statusDraft: '草稿',
        gitStatus: 'Git 状态',
        commits: '提交记录',
    ...
    sessionInfo: {
        ...
        delegationHistory: '委派记录',
        delegationHistorySubtitle: '查看当前会话发起的委派任务及执行状态',
        sharedSession: '共享会话',
        viewMachine: '查看设备',
        markAsRead: '标记已读',
        markAsUnread: '标记未读',
        ...
        leaveSharedSessionSubtitle: '从你的列表中移除此共享会话',
        leaveSharedSessionConfirm: '确定要退出此共享会话吗？退出后需要对方重新分享才能再次访问。',
        renameSession: '重命名会话',
    ...
    files: {
        preview: {
            ...
            downloadFailed: "下载失败，请检查连接、更新 CLI 后重试；如有其他下载，请等待其完成。",
            title: "预览",
            source: "源码",
            worktree: "工作区",
            index: "暂存版本",
            commit: "提交",
            deleted: "已删除：显示删除前版本",
            diffUnavailable: "无法获取差异",
            changed: "二进制文件已变更",
            unavailable: "预览不可用，请检查会话连接和 CLI 版本后重试。",
            tooLarge: "文件超过预览上限（文本 2 MiB；PDF/图片 20 MiB）。",
            renderError: "无法渲染此文件",
            ...
            expired: "预览已过期，请重新加载。",
            denied: "无法访问此文件进行预览。",
            unsupported: "文件损坏或格式不受支持",
        },
        statusTitle: '文件状态',
        searchChangesPlaceholder: '搜索更改文件...',
        noPendingChanges: '没有待暂存或待提交的更改',
    ...
    repository: {
        ...
        liveSessions: ({ count }: { count: number }) => `${count} 个进行中`,
        commitsCount: ({ count }: { count: number }) => `${count} 次提交`,
        totalContributorsCount: ({ count }: { count: number }) => `共 ${count} 位贡献者`,
        noContributors: '暂无贡献者',
        searchIssuesPlaceholder: '搜索 Issues…',
        searchPullsPlaceholder: '搜索 Pull Requests…',
        searchSessionsPlaceholder: '搜索会话…',
        emptyIssuesTitle: '暂无 Issue',
        emptyIssuesSubtitle: '创建一个 Issue 来追踪 bug 或想法。',
        ...
        batchDelete: '删除',
        batchArchive: '归档',
        batchDeleteConfirm: ({ count }: { count: number }) => `删除 ${count} 个会话？`,
        batchDeleteWarning: '此操作不可撤销。所有与这些会话相关的消息和数据将被永久删除。',
        batchArchiveConfirm: ({ count }: { count: number }) => `归档 ${count} 个会话？`,
        batchArchiveWarning: '这些会话将被停止并归档。',
        batchDeleteFailed: ({ count }: { count: number }) => `${count} 个会话删除失败`,
        batchArchiveFailed: ({ count }: { count: number }) => `${count} 个会话归档失败`,
        readmoreReadme: '查看完整 README',
        copyIssueUrl: '复制 Issue 链接',
        openInGithub: '在 GitHub 中打开',
        copyIssueNumber: '复制 Issue 编号',
        closeIssue: '关闭 Issue',
        reopenIssue: '重新打开 Issue',
        updateStateFailed: '更新状态失败。',
        issueStatus: '状态',
        issueAuthor: '作者',
        issueLabels: '标签',
        issueCreated: '创建时间',
        ...
        prBranch: '分支',
        prMerged: '已合并',
        closePr: '关闭 Pull Request',
        reopenPr: '重新打开 Pull Request',
    },
    ...
    browser: {
        ...
        loadFailed: '加载失败',
        noMatches: '没有匹配的文件',
        errorNoSession: '当前没有可用会话，请先启动一个会话。',
        errorLoad: '加载文件失败',
    },
    ...
    modals: {
        ...
        reviewDemoQrScannedSuccessfully: '审核演示二维码扫描成功，二维码扫描功能运行正常。'
    },
    ...
    repoSettings: {
        ...
        installGithubAppDesc: '基于 Webhook 的自动化所必需',
        githubAppInstalled: 'GitHub App 已安装',
        machines: '机器和工作目录',
        machinesFooter: '将仓库绑定到机器以启用会话和自动飞行员',
        noMachinesRegistered: '没有已注册的机器',
        noMachinesAvailable: '没有可用的机器。请先添加机器。',
        machineOffline: '离线',
        machineOnline: '在线',
        noMachineAvailable: '没有可用机器',
        noMachineAvailableNewSession: '请先在机器上注册此仓库以创建会话',
        noMachineAvailableAutoPilot: 'Register this repository on an available machine',
        registerRepoOnMachine: '注册到此机器',
        repoAlreadyRegistered: '此仓库已在此机器上注册',
        machineOfflineCannotRegister: '机器离线。请上线后再注册。',
        notBound: '未绑定',
        notBoundDesc: '此仓库未注册在任何机器上。绑定后即可启用会话和自动飞行员。',
        selectMachine: '选择机器',
        changeMachine: '更换机器',
        unbindMachine: '解绑',
        unbindAction: '解绑',
        unbindConfirmTitle: '解绑机器？',
        unbindConfirmMessage: ({ repo }: { repo: string }) => `解绑 ${repo}？机器上已运行的会话不会被删除，可以稍后重新绑定。`,
        confirmPath: '确认路径',
        parentPath: '父路径',
        bindingRepoName: '仓库名称',
        fullPath: '完整路径',
        fullPathPlaceholder: '/Users/xxx/projects/repo-name',
        pathAlreadyExists: '此路径已存在。请选择不同的名称或路径。',
        workingDir: '工作目录',
        targetBranch: '目标分支',
        disabled: 'Disabled',
        custom: 'Custom...',
        ...
        dangerZone: '危险区域',
        removeRepo: '移除仓库',
        removeRepoDesc: '从Happy中移除此仓库。这不会删除GitHub仓库。',
        removeRepoTitle: '移除仓库？',
        removeRepoMessage: ({ repo }: { repo: string }) => `您确定要从此Happy中移除"${repo}"吗？GitHub仓库不会被删除。`,
        clearSessions: '清除本地会话',
        clearSessionsDesc: '删除此仓库的所有本地会话数据',
        clearSessionsTitle: '清除会话？',
        clearSessionsMessage: ({ repo }: { repo: string }) => `您确定要清除"${repo}"的所有本地会话吗？此操作无法撤消。`,
    },


    repoBinding: {
        cannotProbeTitle: '无法检查路径',
        machineOfflineMessage: '目标机器已离线。',
        bashFailedMessage: ({ detail }: { detail: string }) => `检查机器路径失败：${detail || '未知错误'}`,
        wrongRemoteTitle: '不同的仓库',
        wrongRemoteMessage: ({ found, expected }: { found: string; expected: string }) => `该目录是 ${found} 的克隆，而不是 ${expected}。请选择其他路径。`,
        dirNotEmptyTitle: '目录非空',
        dirNotEmptyMessage: ({ path }: { path: string }) => `${path} 不是 git 仓库且包含文件。请选择空目录或一个尚不存在的路径。`,
        cloneConfirmTitle: ({ slug }: { slug: string }) => `克隆 ${slug}？`,
        cloneConfirmMissingMessage: ({ path }: { path: string }) => `${path} 在机器上不存在。是否将仓库克隆到这里？`,
        cloneConfirmEmptyMessage: ({ path }: { path: string }) => `${path} 为空。是否将仓库克隆到此目录？`,
        cloneAction: '克隆',
        cloningTitle: ({ slug }: { slug: string }) => `正在克隆 ${slug}…`,
        cloningElapsed: ({ seconds }: { seconds: string }) => `${seconds}s`,
        cloningWaiting: '等待 git 输出…',
        cloningHint: '首次克隆可能需要一分钟，请保持应用打开。',
        cloneSucceededTitle: '克隆成功',
        cloneFailedTitle: '克隆失败',
        cloneNoOutput: '（无输出）',
        cloneFailedHint: '请确认机器已登录 GitHub（在机器上运行 `gh auth login`），或手动克隆。',
    },

    chatSession: {
        cardTitle: '讨论这个 issue',
        cardSubtitle: '打开一个已加载 issue 上下文的会话',
        machineUnavailableTitle: '机器不可用',
        machineUnavailableMessage: '讨论需要绑定一台在线机器才能进行。请到仓库设置选择或更换机器。',
        openRepoSettings: '前往仓库设置',
    },
    ...
    issueComments: {
        ...
        submit: '发表',
        errorTitle: '错误',
        errorReconnect: '请使用最新权限重新连接你的 GitHub 账号。',
        errorFallback: '发表评论失败。',
        takePhoto: '拍照',
        chooseFromAlbum: '从相册选择',
        ...
        deleteConfirmMessage: '确定要删除这条评论吗？此操作无法撤销。',
        deleteFailed: '删除评论失败。',
        editFailed: '更新评论失败。',
    },
    ...
    lab: {
        ...
        screenTitle: '仓库',
        addRepositoryTitle: '添加仓库',
        addByUrl: '通过链接添加',
        addByUrlPlaceholder: 'https://github.com/owner/repo',
        directUrl: '直接链接',
        invalidGithubUrl: '请输入有效的 GitHub 仓库链接',
        invalidGitlabUrl: '请输入有效的 GitLab 仓库链接',
        invalidGitUrl: '请输入有效的 git 仓库链接',
        orSelectFromGithub: '或从推荐列表选择',
        yourGithubRepos: '推荐仓库',
        syncFromGithub: '从 GitHub 同步',
        selectAll: '全选',
        addSelected: '添加所选',
        noGithubRepos: '未找到 GitHub 仓库',
        searchPlaceholder: '搜索仓库…',
        searchYourRepos: '搜索你的仓库...',
        emptyTitle: '暂无仓库',
        emptySubtitle: '试试其他搜索词，或点右上角 + 通过链接添加仓库。',
        newSessionShortcut: '仓库 — 从远程地址开始',
        newSessionCardTitle: '仓库',
        newSessionCardSubtitle: '用仓库链接开始，无需本机一直在线',
        cloudMachineAlertTitle: '云端环境',
        cloudMachineStartMessage: '正在启动云端环境…\n\n（演示：尚未实现）',
        cloudMachineStopMessage: '正在停止云端环境…\n\n（演示：尚未实现）',
        alertAddingRepoTitle: '添加仓库',
        alertRepoAddedTitle: '已添加仓库',
        mockNotImplemented: '（演示：尚未实现）',
        issueNotFound: '未找到该 Issue',
        newIssue: '新建 Issue',
        newPullRequest: 'New Pull Request',
        pullRequestNotFound: '找不到该 Pull Request',
        repoNotFound: '未找到该仓库',
        addButton: '添加',
        addFirstRepo: '添加一个仓库',
        addIntroTitle: '添加一个仓库',
        addIntroSubtitle: '粘贴 Git URL，或从 GitHub 选择仓库。下一步将其绑定到一台机器。',
        repoUrlLabel: '仓库 URL',
        repoUrlHint: '输入仓库的完整 URL',
        usernameLabel: '用户名（可选）',
        usernamePlaceholder: '你的 GitHub 或 GitLab 用户名',
        usernameHint: '私有仓库需要填写',
        tokenLabel: '访问令牌 / 密码（可选）',
        tokenPlaceholder: 'Personal access token 或密码',
        tokenHint: '凭证将加密存储',
        importFromGithub: '从 GitHub 导入',
        startAiFixTitle: '开始 AI 修复',
        retryAiFixTitle: '重试 AI 修复',
        newSessionMockTitle: '新建会话',
        quickActionAiFixIssues: 'AI 修复 Issue',
        issueRowAiFix: 'AI 修复',
        startCloudEnvironment: '启动云端环境',
        quickActions: '快捷操作',
        cloudStop: '停止',
        cloudStart: '启动',
        machinesTab: '机器',
        addMachine: '添加机器',
        machineQrTitle: '命令行启动',
        machineQrSubtitle: '在机器上运行 happy agent --register',
        machineQrRunHint: '在你的机器上运行此命令：',
        machineQrWaiting: '等待 Agent 连接…',
        machineQrSimulate: '模拟连接',
        machineQrSuccess: 'Agent 已连接！',
        machineDockerTitle: 'Docker 运行',
        machineDockerSubtitle: '在容器中运行 Happy Agent',
        machineDockerCommand: 'docker run happy-agent',
        machineDockerGenerating: '正在生成 Docker 命令…',
        machineDockerRunHint: '复制并在 Docker 主机上运行此命令：',
        machineDockerWaiting: '等待 Docker 容器连接…',
        machineDockerTokenWarning: '此命令包含一次性认证令牌，请立即保存——稍后无法找回。',
        machineDockerSuccess: 'Docker Agent 已连接！',
        machineServerTitle: '服务器云',
        machineServerSubtitle: '创建由服务器托管的云端机器',
        machineServerNamePlaceholder: '机器名称（可选）',
        machineServerCreate: '创建服务器机器',
        machineServerSuccess: '服务器云端机器已创建！',
        machineCopy: '复制',
        machineCopied: '命令已复制',
        machineViewMachine: '查看机器',
        machineRegisterTitle: '注册机器',
        machineRegisterDocker: '运行 Docker 命令',
        machineSectionRecommended: '推荐方式',
        machineSectionOther: '其他方式',
        machineDockerRegenerate: '重新生成命令',
        machineSuccessTitle: '机器注册成功',
        machineSuccessSubtitle: 'Agent 已连接，可以开始使用了。',
        machineTypeLocal: '本地',
        machineTypeCloud: '云端',
        machinesSelect: '选择',
        machinesDone: '完成',
        machinesDeleteCount: ({ count }: { count: number }) => `删除 (${count})`,
        machinesDeleteOneTitle: '删除机器？',
        machinesDeleteOneMessage: '将从你的账户中移除此机器。此操作无法撤销。',
        machinesDeleteManyTitle: '删除机器？',
        machinesDeleteManyMessage: ({ count }: { count: number }) => `从你的账户中移除 ${count} 台机器？此操作无法撤销。`,
        machinesDeleteFailed: '删除机器失败',
        machineStatusOnline: '在线',
        machineStatusOffline: '离线',
        machineCloudProvisioning: '创建中…',
        machineCloudFailedShort: '失败',
        machineCloudFailed: ({ error }: { error: string }) => `创建失败：${error}`,
        launchTypeDocker: 'Docker',
        launchTypeCloud: '云端托管',
    },
