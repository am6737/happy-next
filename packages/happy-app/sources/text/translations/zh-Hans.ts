...
export const zhHans: TranslationStructure = {
    ...
    repoSettings: {
        ...
        noMachineAvailableAutoPilot: '请先在可用机器上注册此仓库以使用 Auto Pilot',
        ...
        automationEnabledDesc: '启用AI问题自动化',
        autoPilotNewIssues: '自动修复新问题',
        autoPilotNewIssuesDesc: '创建新问题时自动启动AI代理',
        scheduled: '计划自动修复',
        selectSchedule: '选择定时计划',
        custom: '自定义...',
        customCron: '自定义Cron表达式',
        customCronMessage: '输入Cron表达式（例如：0 * * * * 表示每小时）',
        customCronHelp: 'Cron格式：分 时 日 月 星期。例如：0 */6 * * * 表示每6小时执行一次。',
        disabled: '已禁用',
        triggerLabels: '触发标签',
        triggerLabelsFooter: 'AI只会自动修复带有这些标签的问题',
        dangerZone: '危险区域',
        removeRepo: '移除仓库',
    ...
    lab: {
        ...
        machineManualTitle: '手动连接',
        machineManualSubtitle: '通过自定义端点连接',
        machineManualPlaceholder: 'https://your-machine:3000',
        machineManualConnect: '连接',
        machineManualUrlInvalid: 'URL 格式无效',
        machineCopied: '命令已复制',
        machineRegisterTitle: '注册机器',
        machineRegisterQr: '扫码注册',
        machineRegisterDocker: '运行 Docker 命令',
        machineRegisterManual: '手动连接',
        machineTypeLocal: '本地',
        machineTypeCloud: '云端',
    },
