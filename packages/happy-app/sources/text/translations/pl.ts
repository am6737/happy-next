...
export const pl: TranslationStructure = {
    ...
    repoSettings: {
        ...
        repoSize: 'Rozmiar',
        githubSync: 'Synchronizacja GitHub',
        ...
        machinesFooter: 'Powiąż to repozytorium z maszyną, aby włączyć sesje i autopilota',
        ...
        noMachineAvailableAutoPilot: 'Zarejestruj to repozytorium na dostępnej maszynie, aby korzystać z Auto Pilot',
        ...
        notBoundDesc: 'To repozytorium nie jest zarejestrowane na żadnej maszynie. Powiąż je, aby włączyć sesje i autopilota.',
        selectMachine: 'Wybierz maszynę',
        ...
        automationEnabledDesc: 'Włącz automatyzację zgłoszeń AI',
        autoPilotNewIssues: 'Automatyczne naprawianie nowych zgłoszeń',
        autoPilotNewIssuesDesc: 'Automatycznie uruchamiaj agenta AI przy tworzeniu nowych zgłoszeń',
        scheduled: 'Zaplanowany Auto Pilot',
        selectSchedule: 'Wybierz harmonogram',
        custom: 'Własne...',
        customCron: 'Własne wyrażenie cron',
        customCronMessage: 'Wprowadź wyrażenie cron (np. 0 * * * * dla co godzinę)',
        customCronHelp: 'Format cron: minuta godzina dzień-miesiąc miesiąc dzień-tygodnia. Przykład: 0 */6 * * * uruchamia się co 6 godzin.',
        disabled: 'Wyłączone',
        triggerLabels: 'Etykiety wyzwalające',
        triggerLabelsFooter: 'AI będzie automatycznie naprawiać tylko zgłoszenia z tymi etykietami',
    ...
    lab: {
        ...
        machineManualTitle: 'Ręczny URL',
        machineManualSubtitle: 'Połącz przez niestandardowy endpoint',
        machineManualPlaceholder: 'https://your-machine:3000',
        machineManualConnect: 'Połącz',
        machineManualUrlInvalid: 'Nieprawidłowy format URL',
        machineCopied: 'Polecenie skopiowane',
        machineRegisterTitle: 'Zarejestruj maszynę',
        machineRegisterQr: 'Skanuj aby zarejestrować',
        machineRegisterDocker: 'Uruchom polecenie Docker',
        machineRegisterManual: 'Połączenie ręczne',
