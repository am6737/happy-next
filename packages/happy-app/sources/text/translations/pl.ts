...
export const pl: TranslationStructure = {
    ...
    session: {
        ...
        attachmentDownloadFailed: 'Nie można pobrać tego załącznika',
        fileTooLarge: 'Pliki nie mogą przekraczać 25 MB',
        tooManyAttachments: 'Możesz załączyć maksymalnie 10 plików',
        attachmentsUnsupported: 'Załączniki wymagają zaktualizowanego CLI. Zaktualizuj lub uruchom ponownie CLI i spróbuj ponownie.',
        pasteFromClipboard: 'Wklej ze schowka',
        dropImagesToAttach: 'Upuść obrazy, aby je załączyć',
        dropFilesToAttach: 'Upuść pliki, aby je załączyć',
        sharing: {
            title: 'Udostępnianie',
