...
export const pl: TranslationStructure = {
    ...
    settings: {
        ...
        terminal: 'Terminal',
        terminalSubtitle: 'Otwieraj powłoki na połączonych maszynach',
        history: 'History',
    ...
    dootask: {
        ...
        qrLogin: 'Logowanie kodem QR',
        switchToAccount: 'Logowanie do konta',
        switchToQr: 'Logowanie kodem QR',
        qrLoginHint: 'Zeskanuj kod QR w aplikacji mobilnej DooTask, aby się zalogować',
        qrRefresh: 'Dotknij kodu QR, aby go odświeżyć',
    ...
    github: {
        ...
        searchPullRequests: 'Szukaj pull requestów...',
        searchRepos: 'Szukaj repozytoriów...',
        selectRepo: 'Wybierz repozytorium',
        switchRepo: 'Zmień repozytorium',
        findRepo: 'Znajdź repozytorium...',
        pinned: 'Przypięte',
        allRepos: 'Wszystkie repozytoria',
        allReposDescription: 'Zgłoszenia i pull requesty ze wszystkich repozytoriów',
        assignedToMe: 'Przypisane do mnie',
        createdByMe: 'Utworzone przeze mnie',
        reviewRequested: 'Prośba o recenzję',
        noRepos: 'Nie znaleziono repozytoriów',
        noIssues: 'Nie znaleziono zgłoszeń',
        noPullRequests: 'Nie znaleziono pull requestów',
        comments: 'Komentarze',
        aiSession: 'Sesja AI',
        connectFirst: 'Połącz swoje konto GitHub w Ustawieniach, aby rozpocząć.',
        relatedSessions: 'Powiązane sesje',
    ...
    settingsAppearance: {
        ...
        foldTurnProcess: 'Zwijaj zakończone kroki',
        foldTurnProcessDescription: 'Zakończona tura pokazuje wywołania narzędzi w jednej linii, którą można rozwinąć',
    ...
    settingsDesktop: {
        ...
        footer: 'Steruje zachowaniem Happy Next jako aplikacji komputerowej.',
        nativeNotificationsTitle: 'Powiadomienia systemowe',
        nativeNotificationsSubtitle: 'Pokazuj systemowe powiadomienia o nowych wiadomościach',
        closeToTrayTitle: 'Zamykaj do zasobnika',
        closeToTraySubtitle: 'Utrzymuj połączenie po zamknięciu okna',
        autostartTitle: 'Uruchamiaj po zalogowaniu',
        autostartSubtitle: 'Uruchamiaj ukryte w zasobniku po zalogowaniu',
        shortcutTitle: 'Globalny skrót pokaż/ukryj',
        shortcutSubtitle: 'Użyj Cmd/Ctrl+Shift+H w dowolnym miejscu',
    ...
    newSession: {
        ...
        repos: {
            ...
            folderPicker: {
                ...
                inlineConfirmTitle: 'Potwierdź ścieżkę klonowania',
                inlineConfirmDescription: 'Repozytorium zostanie sklonowane w tej ścieżce na maszynie.',
                inlineConfirmPathLabel: 'Pełna ścieżka',
                inlineConfirmBrowse: 'Przeglądaj',
                inlineConfirmCancel: 'Anuluj',
                inlineConfirmConfirm: 'Potwierdź',
                toggleHidden: 'Pokaż ukryte katalogi',
            },
    ...
    sessionInfo: {
        ...
        markerOrange: 'Pomarańczowy znacznik',
        markerYellow: 'Żółty znacznik',
        markerGreen: 'Zielony znacznik',
        markerBlue: 'Niebieski znacznik',
        markerPurple: 'Fioletowy znacznik',
        markerGray: 'Szary znacznik',
        ...
        delegationHistory: 'Historia delegowania',
        delegationHistorySubtitle: 'Wyświetl zadania delegowane z tej rozmowy oraz ich stan',
        ...
        updateCliInstructions: 'Proszę uruchomić happy update',
    ...
    tools: {
        ...
        askUserQuestion: {
            ...
            answered: ({ answer }: { answer: string }) => `Odpowiedź: ${answer}`,
        }
    },
    ...
    files: {
        ...
        statusTitle: 'Stan plików',
        searchChangesPlaceholder: 'Szukaj zmienionych plików...',
        noPendingChanges: 'Brak zmian oczekujących na przygotowanie lub zatwierdzenie',
    ...
    repository: {
        ...
        commits: 'Commity',
        sectionCode: 'Kod',
        sectionActivity: 'Aktywność',
        branch: 'Gałąź',
        contributors: 'Współtwórcy',
        issues: 'Issues',
        pulls: 'Pull Requests',
        sessions: 'Sesje',
        settings: 'Ustawienia repozytorium',
        private: 'Prywatne',
        public: 'Publiczne',
        updatedAgo: ({ time }: { time: string }) => `Zaktualizowano ${time}`,
        liveSessions: ({ count }: { count: number }) => `${count} aktywnych`,
        commitsCount: ({ count }: { count: number }) => `${count} commit${count !== 1 ? 'ów' : ''}`,
        totalContributorsCount: ({ count }: { count: number }) => `${count} contributor${count !== 1 ? 's' : ''} total`,
        noContributors: 'Brak współtwórców',
        ...
        emptyIssuesSubtitle: 'Utwórz zgłoszenie, aby śledzić błędy lub pomysły.',
        ...
        selectedCount: ({ count }: { count: number }) => `Zaznaczono: ${count}`,
        batchDelete: 'Usuń',
        batchArchive: 'Archiwizuj',
        batchDeleteConfirm: ({ count }: { count: number }) => `Usunąć ${count} sesji?`,
        batchDeleteWarning: 'Tej operacji nie można cofnąć. Wszystkie wiadomości i dane powiązane z tymi sesjami zostaną trwale usunięte.',
        batchArchiveConfirm: ({ count }: { count: number }) => `Zarchiwizować ${count} sesji?`,
        batchArchiveWarning: 'Te sesje zostaną zatrzymane i zarchiwizowane.',
        batchDeleteFailed: ({ count }: { count: number }) => `Nie udało się usunąć ${count} sesji`,
        batchArchiveFailed: ({ count }: { count: number }) => `Nie udało się zarchiwizować ${count} sesji`,
        readmoreReadme: 'Read full README',
        issueStatus: 'Status',
        issueAuthor: 'Autor',
        issueLabels: 'Etykiety',
        issueCreated: 'Utworzono',
        issueDescription: 'Opis',
        noDescription: 'Nie podano opisu.',
        copyPrUrl: 'Kopiuj URL PR',
        copyPrNumber: 'Kopiuj numer PR',
        prBranch: 'Gałąź',
        prMerged: 'Scalono',
        closePr: 'Zamknij Pull Request',
        reopenPr: 'Otwórz ponownie Pull Request',
        copyIssueUrl: 'Kopiuj URL zgłoszenia',
        openInGithub: 'Otwórz w GitHub',
        copyIssueNumber: 'Kopiuj numer zgłoszenia',
        closeIssue: 'Zamknij zgłoszenie',
        reopenIssue: 'Otwórz zgłoszenie ponownie',
        updateStateFailed: 'Nie udało się zaktualizować statusu.',
    },
    ...
    modals: {
        ...
        reviewDemoQrScannedSuccessfully: 'Kod QR demonstracyjny do weryfikacji został pomyślnie zeskanowany. Skaner QR działa prawidłowo.'
    },
    ...
    repoSettings: {
        ...
        public: 'Publiczne',
        private: 'Prywatne',
        defaultBranch: 'Gałąź domyślna',
        language: 'Język',
        lastPush: 'Ostatni push',
        repoSize: 'Rozmiar',
        github: 'GitHub',
        githubAccount: 'Konto GitHub',
        notConnected: 'Nie połączono',
        viewOnGithub: 'Otwórz w GitHubie',
        installGithubApp: 'Zainstaluj GitHub App',
        installGithubAppDesc: 'Wymagane do automatyzacji opartej na webhookach',
        githubAppInstalled: 'GitHub App zainstalowana',
        machines: 'Maszyny i katalogi robocze',
        machinesFooter: 'Bind this repo to a machine for sessions',
        noMachinesRegistered: 'Brak zarejestrowanych maszyn',
        noMachinesAvailable: 'Brak dostępnych maszyn. Najpierw dodaj maszynę.',
        machineOffline: 'offline',
        machineOnline: 'online',
        noMachineAvailable: 'Brak dostępnych maszyn',
        noMachineAvailableNewSession: 'Zarejestruj to repozytorium na maszynie, aby utworzyć sesje',
        noMachineAvailableAutoPilot: 'Register this repository on an available machine',
        registerRepoOnMachine: 'Zarejestruj na tej maszynie',
        repoAlreadyRegistered: 'To repozytorium jest już zarejestrowane na tej maszynie',
        machineOfflineCannotRegister: 'Maszyna jest offline. Połącz się, aby zarejestrować.',
        notBound: 'Nie powiązane',
        notBoundDesc: 'This repository is not registered on any machine. Bind it to enable sessions.',
        selectMachine: 'Wybierz maszynę',
        changeMachine: 'Zmień maszynę',
        unbindMachine: 'Odepnij',
        unbindAction: 'Odepnij',
        unbindConfirmTitle: 'Odepnij maszynę?',
        unbindConfirmMessage: ({ repo }: { repo: string }) => `Odpiąć ${repo}? Istniejące sesje na maszynie zostaną zachowane; można powiązać ponownie później.`,
        confirmPath: 'Potwierdź ścieżkę',
        parentPath: 'Ścieżka nadrzędna',
        bindingRepoName: 'Nazwa repozytorium',
        fullPath: 'Pełna ścieżka',
        fullPathPlaceholder: '/Users/xxx/projects/repo-name',
        pathAlreadyExists: 'Ta ścieżka już istnieje. Wybierz inną nazwę lub ścieżkę.',
        ...
        selectSchedule: 'Wybierz harmonogram',
        dangerZone: 'Strefa zagrożenia',
        removeRepo: 'Usuń repozytorium',
        removeRepoDesc: 'Usuń to repozytorium z Happy. Nie usunie to repozytorium GitHub.',
        removeRepoTitle: 'Usunąć repozytorium?',
        removeRepoMessage: ({ repo }: { repo: string }) => `Czy na pewno chcesz usunąć "${repo}" z Happy? Nie usunie to repozytorium GitHub.`,
        clearSessions: 'Wyczyść lokalne sesje',
        clearSessionsDesc: 'Usuń wszystkie lokalne dane sesji dla tego repozytorium',
        clearSessionsTitle: 'Wyczyścić sesje?',
        clearSessionsMessage: ({ repo }: { repo: string }) => `Czy na pewno chcesz wyczyścić wszystkie lokalne sesje dla "${repo}"? Nie można tego cofnąć.`,
    },


    repoBinding: {
        cannotProbeTitle: 'Nie można sprawdzić ścieżki',
        machineOfflineMessage: 'Maszyna docelowa jest offline.',
        bashFailedMessage: ({ detail }: { detail: string }) => `Nie udało się sprawdzić ścieżki na maszynie: ${detail || 'nieznany błąd'}`,
        wrongRemoteTitle: 'Inne repozytorium',
        wrongRemoteMessage: ({ found, expected }: { found: string; expected: string }) => `Ten katalog to klon ${found}, a nie ${expected}. Wybierz inną ścieżkę.`,
        dirNotEmptyTitle: 'Katalog nie jest pusty',
        dirNotEmptyMessage: ({ path }: { path: string }) => `${path} nie jest repozytorium git i zawiera pliki. Wybierz pusty katalog lub jeszcze nieistniejącą ścieżkę.`,
        cloneConfirmTitle: ({ slug }: { slug: string }) => `Sklonować ${slug}?`,
        cloneConfirmMissingMessage: ({ path }: { path: string }) => `${path} nie istnieje na maszynie. Sklonować repozytorium tutaj?`,
        cloneConfirmEmptyMessage: ({ path }: { path: string }) => `${path} jest pusty. Sklonować repozytorium do tego katalogu?`,
        cloneAction: 'Sklonuj',
        cloningTitle: ({ slug }: { slug: string }) => `Klonowanie ${slug}…`,
        cloningElapsed: ({ seconds }: { seconds: string }) => `${seconds} s`,
        cloningWaiting: 'Oczekiwanie na wyjście git…',
        cloningHint: 'Pierwsze klonowanie może zająć minutę. Nie zamykaj aplikacji.',
        cloneSucceededTitle: 'Klonowanie powiodło się',
        cloneFailedTitle: 'Klonowanie nie powiodło się',
        cloneNoOutput: '(brak wyjścia)',
        cloneFailedHint: 'Upewnij się, że maszyna jest zalogowana do GitHub (uruchom `gh auth login` na maszynie) lub sklonuj ręcznie.',
    },

    chatSession: {
        cardTitle: 'Porozmawiaj o tym issue',
        cardSubtitle: 'Otwórz sesję z wstępnie załadowanym kontekstem issue',
        machineUnavailableTitle: 'Maszyna niedostępna',
        machineUnavailableMessage: 'Do dyskusji potrzebna jest dostępna online maszyna powiązana z repozytorium. Otwórz ustawienia repozytorium, aby ją wybrać lub zmienić.',
        openRepoSettings: 'Otwórz ustawienia repo',
    },
    ...
    issueComments: {
        ...
        submit: 'Skomentuj',
        errorTitle: 'Błąd',
        errorReconnect: 'Proszę ponownie połączyć konto GitHub z zaktualizowanymi uprawnieniami.',
        errorFallback: 'Nie udało się opublikować komentarza.',
        takePhoto: 'Zrób zdjęcie',
        chooseFromAlbum: 'Wybierz z albumu',
        ...
        edit: 'Edytuj',
        delete: 'Usuń',
        editing: 'Edytowanie komentarza…',
        deleteConfirmTitle: 'Usuń komentarz',
        deleteConfirmMessage: 'Czy na pewno chcesz usunąć ten komentarz? Tego nie można cofnąć.',
        deleteFailed: 'Nie udało się usunąć komentarza.',
        editFailed: 'Nie udało się zaktualizować komentarza.',
    },

    issueDetail: {
        aiSession: 'Rozpocznij sesję AI',
    },
    ...
    lab: {
        ...
        pullRequestNotFound: 'Pull request not found',
        ...
        machinesTab: 'Maszyny',
        addMachine: 'Dodaj maszynę',
        machineQrTitle: 'Wiersz poleceń',
        machineQrSubtitle: 'Uruchom happy agent --register na swojej maszynie',
        machineQrRunHint: 'Uruchom to polecenie na swojej maszynie:',
        machineQrWaiting: 'Oczekiwanie na połączenie agenta…',
        machineQrSimulate: 'Symuluj połączenie',
        machineQrSuccess: 'Agent połączony!',
        machineDockerTitle: 'Docker Run',
        machineDockerSubtitle: 'Uruchom Happy Agent w kontenerze',
        machineDockerCommand: 'docker run happy-agent',
        machineDockerGenerating: 'Generowanie polecenia Docker…',
        machineDockerRunHint: 'Skopiuj i uruchom to polecenie na hoście Docker:',
        machineDockerWaiting: 'Oczekiwanie na połączenie kontenera Docker…',
        machineDockerTokenWarning: 'Polecenie zawiera jednorazowy token. Zapisz je teraz — nie można go odzyskać później.',
        machineDockerSuccess: 'Agent Docker połączony!',
        machineServerTitle: 'Server Cloud',
        machineServerSubtitle: 'Utwórz maszynę chmurową zarządzaną przez serwer',
        machineServerNamePlaceholder: 'Nazwa maszyny (opcjonalne)',
        machineServerCreate: 'Utwórz maszynę serwerową',
        machineServerSuccess: 'Maszyna w chmurze utworzona!',
        machineCopy: 'Kopiuj',
        machineCopied: 'Polecenie skopiowane',
        machineViewMachine: 'Zobacz maszynę',
        machineRegisterTitle: 'Zarejestruj maszynę',
        machineRegisterDocker: 'Uruchom polecenie Docker',
        machineSectionRecommended: 'Zalecane',
        machineSectionOther: 'Inne metody',
        machineDockerRegenerate: 'Wygeneruj polecenie ponownie',
        machineSuccessTitle: 'Maszyna zarejestrowana',
        machineSuccessSubtitle: 'Twój agent jest połączony i gotowy do użycia.',
        machineTypeLocal: 'Lokalna',
        machineTypeCloud: 'Chmurowa',
        machinesSelect: 'Wybierz',
        machinesDone: 'Gotowe',
        machinesDeleteCount: ({ count }: { count: number }) => `Usuń (${count})`,
        machinesDeleteOneTitle: 'Usunąć maszynę?',
        machinesDeleteOneMessage: 'Maszyna zostanie usunięta z Twojego konta. Tej operacji nie można cofnąć.',
        machinesDeleteManyTitle: 'Usunąć maszyny?',
        machinesDeleteManyMessage: ({ count }: { count: number }) => `Usunąć ${count} maszyn z Twojego konta? Tej operacji nie można cofnąć.`,
        machinesDeleteFailed: 'Nie udało się usunąć maszyny',
        machineStatusOnline: 'Online',
        machineStatusOffline: 'Offline',
        machineCloudProvisioning: 'Tworzenie…',
        machineCloudFailedShort: 'Błąd',
        machineCloudFailed: ({ error }: { error: string }) => `Błąd tworzenia: ${error}`,
