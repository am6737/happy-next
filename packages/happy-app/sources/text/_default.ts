...
export const en = {
    ...
    dootask: {
        ...
        qrLoginHint: 'Use the DooTask mobile app to scan the QR code',
        qrRefresh: 'Tap the QR code to refresh',
    ...
    github: {
        ...
        allReposDescription: 'Issues and pull requests across your repositories',
        ...
        connectFirst: 'Connect your GitHub account in Settings to get started.',
        relatedSessions: 'Related Sessions',
        tokenExpired: 'GitHub Connection Expired',
        tokenExpiredDesc: 'Your GitHub token has expired. Please reconnect your account to continue.',
        reconnect: 'Reconnect',
    ...
    settingsAppearance: {
        ...
        foldTurnProcess: 'Fold Finished Steps',
        foldTurnProcessDescription: 'A finished turn shows its tool calls as a single line, which opens when tapped',
    ...
    newSession: {
        ...
        repos: {
            ...
            folderPicker: {
                ...
                inlineConfirmTitle: 'Confirm clone path',
                inlineConfirmDescription: 'The repository will be cloned at this path on the machine.',
                inlineConfirmPathLabel: 'Full path',
                inlineConfirmBrowse: 'Browse',
                inlineConfirmCancel: 'Cancel',
                inlineConfirmConfirm: 'Confirm',
                toggleHidden: 'Show hidden directories',
            },
    ...
    sessionInfo: {
        ...
        markerGreen: 'Green marker',
        markerBlue: 'Blue marker',
        markerPurple: 'Purple marker',
        markerGray: 'Gray marker',
        ...
        openTerminalSubtitle: 'Open a shell in this session\'s working directory',
    ...
    agentInput: {
        ...
        context: {
            ...
            details: ({ usedPercent, remainingPercent, usedTokens, totalTokens }: { usedPercent: number; remainingPercent: number; usedTokens: string; totalTokens: string }) => `Context window:\n${usedPercent}% used (${remainingPercent}% left)\n${usedTokens} tokens used, ${totalTokens} total`,
        },
        suggestion: {
            fileLabel: 'FILE',
            folderLabel: 'FOLDER',
    ...
    repository: {
        ...
        private: 'Private',
        public: 'Public',
        updatedAgo: ({ time }: { time: string }) => `Updated ${time}`,
        liveSessions: ({ count }: { count: number }) => `${count} live`,
        ...
        emptyIssuesSubtitle: 'Open an issue to track bugs or ideas.',
        ...
        batchDelete: 'Delete',
        batchDeleteConfirm: ({ count }: { count: number }) => `Delete ${count} session(s)?`,
        batchDeleteWarning: 'This action cannot be undone.',
        batchDeleteFailed: ({ count }: { count: number }) => `Failed to delete ${count} session(s).`,
        batchArchive: 'Archive',
        batchArchiveConfirm: ({ count }: { count: number }) => `Archive ${count} session(s)?`,
        batchArchiveWarning: 'Archived sessions can be restored later.',
        batchArchiveFailed: ({ count }: { count: number }) => `Failed to archive ${count} session(s).`,
        ...
        updateStateFailed: 'Failed to update status.',
    },
    ...
    modals: {
        ...
        reviewDemoQrScannedSuccessfully: 'Review demo QR code scanned successfully. The QR scanner is working correctly.'
    },
    ...
    repoSettings: {
        ...
        installGithubAppDesc: 'Required for webhook-based automation',
        githubAppInstalled: 'GitHub App Installed',
        machines: 'Machines & Working Directories',
        machinesFooter: 'Bind this repo to a machine for sessions',
        noMachinesRegistered: 'No machines registered for this repository',
        noMachinesAvailable: 'No machines available. Add a machine first.',
        machineOffline: 'Offline',
        machineOnline: 'Online',
        noMachineAvailable: 'No Machine Available',
        noMachineAvailableNewSession: 'Register this repository on a machine to create sessions',
        noMachineAvailableAutoPilot: 'Register this repository on an available machine',
        registerRepoOnMachine: 'Register on this machine',
        repoAlreadyRegistered: 'This repository is already registered on this machine',
        machineOfflineCannotRegister: 'Machine is offline. Bring it online to register.',
        notBound: 'Not Bound',
        notBoundDesc: 'This repository is not registered on any machine. Bind it to enable sessions.',
        selectMachine: 'Select Machine',
        changeMachine: 'Change Machine',
        unbindMachine: 'Unbind',
        unbindAction: 'Unbind',
        unbindConfirmTitle: 'Unbind machine?',
        unbindConfirmMessage: ({ repo }: { repo: string }) => `Unbind ${repo}? Existing sessions on the machine are kept; you can re-bind later.`,
        confirmPath: 'Confirm Path',
        parentPath: 'Parent Path',
        bindingRepoName: 'Repo Name',
        fullPath: 'Full Path',
        fullPathPlaceholder: '/Users/xxx/projects/repo-name',
        pathAlreadyExists: 'This path already exists. Please choose a different name or path.',
        ...
        removeRepoDesc: 'Remove this repository from Happy. This will not delete the GitHub repository.',
        removeRepoTitle: 'Remove Repository?',
        removeRepoMessage: ({ repo }: { repo: string }) => `Are you sure you want to remove "${repo}" from Happy? This will not delete the GitHub repository.`,
        clearSessions: 'Clear Local Sessions',
        clearSessionsDesc: 'Delete all local session data for this repository',
        clearSessionsTitle: 'Clear Sessions?',
        clearSessionsMessage: ({ repo }: { repo: string }) => `Are you sure you want to clear all local sessions for "${repo}"? This cannot be undone.`,
    },

    repoBinding: {
        cannotProbeTitle: 'Cannot inspect path',
        machineOfflineMessage: 'The target machine is offline.',
        bashFailedMessage: ({ detail }: { detail: string }) => `Failed to inspect the path on the machine: ${detail || 'unknown error'}`,
        wrongRemoteTitle: 'Different repository',
        wrongRemoteMessage: ({ found, expected }: { found: string; expected: string }) => `This directory is a clone of ${found}, not ${expected}. Pick a different path.`,
        dirNotEmptyTitle: 'Directory not empty',
        dirNotEmptyMessage: ({ path }: { path: string }) => `${path} is not a git repository and contains files. Pick an empty directory or a path that does not exist yet.`,
        cloneConfirmTitle: ({ slug }: { slug: string }) => `Clone ${slug}?`,
        cloneConfirmMissingMessage: ({ path }: { path: string }) => `${path} does not exist on the machine. Clone the repository here?`,
        cloneConfirmEmptyMessage: ({ path }: { path: string }) => `${path} is empty. Clone the repository into it?`,
        cloneAction: 'Clone',
        cloningTitle: ({ slug }: { slug: string }) => `Cloning ${slug}…`,
        cloningElapsed: ({ seconds }: { seconds: string }) => `${seconds}s`,
        cloningWaiting: 'Waiting for git output…',
        cloningHint: 'First clone may take a minute. Please keep the app open.',
        cloneSucceededTitle: 'Clone succeeded',
        cloneFailedTitle: 'Clone failed',
        cloneNoOutput: '(no output)',
        cloneFailedHint: 'Make sure the machine is signed in to GitHub (run `gh auth login` on the machine) or clone manually.',
    },

    chatSession: {
        cardTitle: 'Chat about this issue',
        cardSubtitle: 'Open a session pre-loaded with the issue context',
        machineUnavailableTitle: 'Machine Unavailable',
        machineUnavailableMessage: 'Discussing this issue requires an online machine bound to the repo. Open repo settings to select or change one.',
        openRepoSettings: 'Open Repo Settings',
    },
    ...
    issueComments: {
        ...
        submit: 'Comment',
        errorTitle: 'Error',
        errorReconnect: 'Please reconnect your GitHub account with updated permissions.',
        ...
        editFailed: 'Failed to update comment.',
    },

    issueDetail: {
        aiSession: 'Start AI Session',
    },

    lab: {
        /** Settings section title only (zh: 实验室). List/entry copy uses Repositories. */
        sectionTitle: 'Lab',
        ...
        addMachine: 'Add Machine',
        machineQrTitle: 'Command Line',
        machineQrSubtitle: 'Run happy agent --register on your machine',
        machineQrRunHint: 'Run this command on your machine:',
        machineQrWaiting: 'Waiting for agent to connect…',
        machineQrSimulate: 'Simulate Connection',
        machineQrSuccess: 'Agent connected!',
        machineDockerTitle: 'Docker Run',
        machineDockerSubtitle: 'Run the Happy Agent in a container',
        machineDockerCommand: 'docker run happy-agent',
        machineDockerGenerating: 'Generating Docker command…',
        machineDockerRunHint: 'Copy and run this command on your Docker host:',
        machineDockerWaiting: 'Waiting for Docker container to connect…',
        machineDockerTokenWarning: 'This command contains a one-time auth token. Save it now — it cannot be retrieved later.',
        machineDockerSuccess: 'Docker agent connected!',
        machineServerTitle: 'Server Cloud',
        machineServerSubtitle: 'Create a cloud machine managed by the server',
        machineServerNamePlaceholder: 'Machine name (optional)',
        machineServerCreate: 'Create Server Machine',
        machineServerSuccess: 'Server cloud machine created!',
        machineCopy: 'Copy',
        machineCopied: 'Command copied',
        machineViewMachine: 'View Machine',
        machineRegisterTitle: 'Register Machine',
        machineRegisterDocker: 'Run Docker Command',
        machineSectionRecommended: 'Recommended',
        machineSectionOther: 'Other Methods',
        machineDockerRegenerate: 'Regenerate command',
        machineSuccessTitle: 'Machine registered',
        machineSuccessSubtitle: 'Your agent is now connected and ready to use.',
        machineTypeLocal: 'Local',
        machineTypeCloud: 'Cloud',
        machinesSelect: 'Select',
        machinesDone: 'Done',
        machinesDeleteCount: ({ count }: { count: number }) => `Delete (${count})`,
        machinesDeleteOneTitle: 'Delete machine?',
        machinesDeleteOneMessage: 'This will remove the machine from your account. This cannot be undone.',
        machinesDeleteManyTitle: 'Delete machines?',
        machinesDeleteManyMessage: ({ count }: { count: number }) => `Remove ${count} machines from your account? This cannot be undone.`,
        ...
        machineCloudFailedShort: 'Failed',
        machineCloudFailed: ({ error }: { error: string }) => `Provisioning failed: ${error}`,
