...
3. For Happy Voice: the voice gateway is auto-discovered from your server — check that your server config exposes a voice base URL and that the app can reach it
