...
- Download is available in the preview/full-screen toolbar and overflow menu.
  Native platforms export through system sharing. Supported original-file exports
  are SVG, HTML/HTM, MD/Markdown, PDF, PNG, JPG/JPEG, GIF and WebP, within the
  preview size limits; other text viewers retain their existing text-sharing flow.
...
cannot be exported through this viewer; use a separate file-transfer workflow.
